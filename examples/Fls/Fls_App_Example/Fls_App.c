...
for (loopCount =1; loopCount < 500; loopCount++)
{
        ...
        AppUtils_Printf(APP_NAME ": Perform ERASE, WRITE, READ, BLANDCHECK, CANCEL, COMPARE, etc\n\r");
    #endif  
...
/********************************************************************************************************************************/
    ...
    /********************************************************************************************************************************/
        ...
        AppUtils_Printf(APP_NAME ": Number of Tests Passed: %d   Number of Tests failed: %d (1 should be happened each loop for Fls_Cancel test)   Loop Number: %d \r\n", Fls_passCnt, Fls_errCnt, loopCount);    
        AppUtils_Printf(APP_NAME ": \n\r");
    #endif
    /*Add breakpoint here, then check the error count in Fee_JobErrorNotification() at the end of this file*/
    /*__asm(" NOP #8");*/
} //loop for debug use
    return (status);
}
