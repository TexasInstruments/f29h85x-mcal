 ...
 *  Generator:  None
 *
 * Description:  This file contains Cdd_Sent Mtp example to read the data from the sent sensor [TLE5014C16D].
 * Sensor details :
 *         Product Type  : TLE5014C16D
 *         Marking       : 014CD
 *         Sensor Type   : SPC Interface
 * 
 * This program will receive sensor data from a magnetic angle sensor -1 using the SENT communication protocol. 
