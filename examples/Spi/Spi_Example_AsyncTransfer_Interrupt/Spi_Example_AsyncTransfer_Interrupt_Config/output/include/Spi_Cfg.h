...
#define SPI_CFG_MAJOR_VERSION           (2U)
...
#define SPI_VARIANT_POST_BUILD        (STD_OFF)
/** \brief  SPI build Link Time variant ON or OFF*/
#define SPI_LINK_TIME_VARIANT         (STD_ON)
 ...
 * Design : MCAL-25149
 */
#define SPI_MAX_CHANNELS            ((uint16)(3U))

/** \brief Maximum jobs across all sequence/hwunit */
/*
 * Design : MCAL-25150
 */
#define SPI_MAX_JOBS                ((uint16)(4U))
 ...
 */
/** \brief Macro defining SPI Instance ISR type */
#define SPI_SPIB_ISR_CAT1_RTINT
...
#define SpiConf_SpiJob_SpiJob_3    ((Spi_JobType) 3U)           /*~ASR~*/
