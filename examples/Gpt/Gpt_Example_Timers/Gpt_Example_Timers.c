...
int main(void)
{
    ...
    if ((Gpt_Interrupt_Cnt[GPT_CHANNEL_0] >= 1) && \
        (Gpt_Interrupt_Cnt[GPT_CHANNEL_1] == 1) && \
...
void Gpt_Notify_Func_0(void)
{
    ...
    AppUtils_Printf("CHANNEL-0: Time_elapsed and Time_remaining values in one shot mode"
