 ...
 *  Generator:    None
 *
 *  Description:  Example application source for CDD XBar to route GPIO0 Aand GPIO4 to GPIO2 using Input and Output crossbar.
 *                Initially the following configurations are made in configurator:
...
int main(void)
{
  ...
  if(Dio_ChannelLevel == STD_HIGH)
  {
    ...
    {
      AppUtils_Printf("=================================================================================\n");
      AppUtils_Printf("PASS: GPIO0(INPUT XBAR1) and GPIO4(INPUT XBAR2) are routed to GPIO2(OUTPUT XBAR1) \n");
    } 
    else
    {
       AppUtils_Printf("=================================================================================\n");
       AppUtils_Printf("FAIL: GPIO0(INPUT XBAR1) and GPIO4(INPUT XBAR2) are not routed to GPIO2(OUTPUT XBAR1) \n");
    }
  }
  else
  {
