...
static CONST( Port_PinConfigType, PORT_CONFIG_DATA) Port_PortConfigSet_PinConfig[6] =
{
   ...
   
   {
    ...
    {
        .Port_AnalogMode = (Port_AnalogModeType)PORT_ANALOG_DISABLED,
        .Port_InitialMuxMode = (Port_PinType)PORT_PIN_3_GPIO3,
        .Port_PinPadConfig = (Port_PinPadConfigType)PORT_PIN_TYPE_STD,
        .Port_PinQualification = (Port_PinQualificationMode)PORT_QUAL_SYNC,
        .Port_PinQualificationPeriod = (uint32)1U,
        .Port_CoreSelect = (Port_PinCoreSelect)PORT_CORE_CPU1,
    ...
    .Port_PinMode =
    {
        ...
        [0] = 
        {
        .Port_PinMuxMode = (Port_PinModeType)PORT_PIN_3_GPIO3
        },
    }
   ...
   
   {
    ...
    {
        .Port_AnalogMode = (Port_AnalogModeType)PORT_ANALOG_DISABLED,
        .Port_InitialMuxMode = (Port_PinType)PORT_PIN_2_OUTPUTXBAR1,
        .Port_PinPadConfig = (Port_PinPadConfigType)PORT_PIN_TYPE_STD,
        .Port_PinQualification = (Port_PinQualificationMode)PORT_QUAL_SYNC,
        .Port_PinQualificationPeriod = (uint32)1U,
        .Port_CoreSelect = (Port_PinCoreSelect)PORT_CORE_CPU1,
    ...
    .Port_PinMode =
    {
        ...
        [0] = 
        {
        .Port_PinMuxMode = (Port_PinModeType)PORT_PIN_2_OUTPUTXBAR1
        },
    }
