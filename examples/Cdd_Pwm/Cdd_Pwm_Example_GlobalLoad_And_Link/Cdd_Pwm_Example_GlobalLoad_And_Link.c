 ...
 * Counter compare values are updated at 3rd period event for all EPWM instances using linking and the configured 
 * global load event prescale is 7. So, the update in the compare compare values(shadow to active at 3rd period event) 
 * can be observed in all instances except EPWM2.
 * Update in the compare compare values(shadow to active at 7rd period event) can be observed in all instances.
 * Disable linking for EPWM1 & EPWM2 instances.
 * Update in the compare compare B for EPWM3 & EPWM4 instances using linking.
...
void Cdd_Pwm_HwUnit0Notification()
{
    ...
    {
        Cdd_Pwm_SetCounterCompareValue(CddPwmConf_CddPwmHwUnitConfig_CddPwmHwUnitConfig_0, CDD_PWM_COUNTER_COMPARE_A, 15825U);
        Cdd_Pwm_SetCounterCompareValue(CddPwmConf_CddPwmHwUnitConfig_CddPwmHwUnitConfig_1, CDD_PWM_COUNTER_COMPARE_A, 15825U);
    }

    if(Cdd_Pwm_NotificationCount[CddPwmConf_CddPwmHwUnitConfig_CddPwmHwUnitConfig_0] == 7U)
    {
        Cdd_Pwm_SetCounterCompareValue(CddPwmConf_CddPwmHwUnitConfig_CddPwmHwUnitConfig_0, CDD_PWM_COUNTER_COMPARE_B, 28325U);
        Cdd_Pwm_SetCounterCompareValue(CddPwmConf_CddPwmHwUnitConfig_CddPwmHwUnitConfig_1, CDD_PWM_COUNTER_COMPARE_B, 28325U);
    }
}
...
void Cdd_Pwm_ConfigureHw()
{
    ...
    // Cdd_Pwm_ConfigureEpwmXLink(CddPwmConf_CddPwmHwUnitConfig_CddPwmHwUnitConfig_0);

    /* Configure for EPWM2 instance */
    // Cdd_Pwm_EnableNotification(CddPwmConf_CddPwmHwUnitConfig_CddPwmHwUnitConfig_1);
    // Cdd_Pwm_ConfigureEpwmXLink(CddPwmConf_CddPwmHwUnitConfig_CddPwmHwUnitConfig_1,TRUE);
    ...
    Cdd_Pwm_ConfigureGlobalLoadRegisters(CddPwmConf_CddPwmHwUnitConfig_CddPwmHwUnitConfig_1, CDD_PWM_GL_REGISTER_CMPA_CMPAHR,TRUE);
    Cdd_Pwm_ConfigureGlobalLoadRegisters(CddPwmConf_CddPwmHwUnitConfig_CddPwmHwUnitConfig_1, CDD_PWM_GL_REGISTER_CMPB_CMPBHR,TRUE);

    /* Configure EPWM3 instance */
    // Cdd_Pwm_EnableNotification(CddPwmConf_CddPwmHwUnitConfig_CddPwmHwUnitConfig_2);
    // Cdd_Pwm_ConfigureEpwmXLink(CddPwmConf_CddPwmHwUnitConfig_CddPwmHwUnitConfig_2,TRUE);

    /* Configure EPWM4 instance */
    // Cdd_Pwm_EnableNotification(CddPwmConf_CddPwmHwUnitConfig_CddPwmHwUnitConfig_3);
    // Cdd_Pwm_ConfigureEpwmXLink(CddPwmConf_CddPwmHwUnitConfig_CddPwmHwUnitConfig_3,TRUE);
    ...
    /* Configure the XLINK memory region */
    Cdd_Pwm_SetClockPrescaler(CddPwmConf_CddPwmXlinkConfig_CddPwmXlinkConfig_0, CDD_PWM_CLOCK_DIVIDER_4, CDD_PWM_HSCLOCK_DIVIDER_8);
    ...
    Cdd_Pwm_SetActionQualifierAction(CddPwmConf_CddPwmXlinkConfig_CddPwmXlinkConfig_0, CDD_PWM_OUTPUT_A, CDD_PWM_AQ_OUTPUT_LOW, CDD_PWM_AQ_OUTPUT_ON_TIMEBASE_ZERO);	
    Cdd_Pwm_SetActionQualifierAction(CddPwmConf_CddPwmXlinkConfig_CddPwmXlinkConfig_0, CDD_PWM_OUTPUT_A, CDD_PWM_AQ_OUTPUT_HIGH, CDD_PWM_AQ_OUTPUT_ON_TIMEBASE_UP_CMPA);
    Cdd_Pwm_SetActionQualifierAction(CddPwmConf_CddPwmXlinkConfig_CddPwmXlinkConfig_0, CDD_PWM_OUTPUT_A, CDD_PWM_AQ_OUTPUT_LOW, CDD_PWM_AQ_OUTPUT_ON_TIMEBASE_UP_CMPB);
}
...
int main()
{
    ...
    /* Disable XLINK for EPWM instances 1 & 2 */
    // Cdd_Pwm_ConfigureEpwmXLink(CddPwmConf_CddPwmHwUnitConfig_CddPwmHwUnitConfig_0);
    // Cdd_Pwm_ConfigureEpwmXLink(CddPwmConf_CddPwmHwUnitConfig_CddPwmHwUnitConfig_1);

    /* Update the counter compare value for the EPWM instances 3 & 4 */
