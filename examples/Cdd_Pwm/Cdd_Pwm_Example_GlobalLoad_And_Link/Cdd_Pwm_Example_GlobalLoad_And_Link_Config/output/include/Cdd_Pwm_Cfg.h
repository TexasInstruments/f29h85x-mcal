...
#define CDD_PWM_CFG_MAJOR_VERSION           (2U)
...
#define CDD_PWM_XLINK_GRP_COUNT     (uint8)(1U)
...
/* Symbolic name for the PWM instance  3 */
#define CddPwmConf_CddPwmHwUnitConfig_CddPwmHwUnitConfig_2   ((Cdd_Pwm_InstanceType)2U)  /*~ASR~*/

/* Symbolic name for the PWM instance  4 */
#define CddPwmConf_CddPwmHwUnitConfig_CddPwmHwUnitConfig_3   ((Cdd_Pwm_InstanceType)3U)  /*~ASR~*/



/* Xlink group 0 symbolic name */
#define CddPwmConf_CddPwmXlinkConfig_CddPwmXlinkConfig_0   ((Cdd_Pwm_InstanceType)4U)  /*~ASR~*/

/* Symbolic names for Hrpwm Cal instances */

#define CddPwmConf_CddPwmHrpwmCalConfig_CddPwmHrpwmCal0   ((Cdd_Pwm_HrpwmCalInstanceType)0U)  /*~ASR~*/

#define CddPwmConf_CddPwmHrpwmCalConfig_CddPwmHrpwmCal1   ((Cdd_Pwm_HrpwmCalInstanceType)1U)  /*~ASR~*/

#define CddPwmConf_CddPwmHrpwmCalConfig_CddPwmHrpwmCal2   ((Cdd_Pwm_HrpwmCalInstanceType)2U)  /*~ASR~*/
...
extern void Cdd_Pwm_HwUnit0Notification(void);

/* Declaration of the notification functions */
extern void Cdd_Pwm_HwUnit1Notification(void);
