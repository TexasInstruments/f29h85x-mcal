 ...
 *
 *****************************************************************************/
#define PORT_CONFIGURATION_LOCK_CRITICAL_REGISTERS        (STD_OFF) 
...
#define PortConf_PortPin_PortPin_4      3U			/*~ASR~*/

#define PortConf_PortPin_PortPin_5      4U			/*~ASR~*/
...
#define PortConf_PortPin_PortPin_9      8U			/*~ASR~*/

#define PortConf_PortPin_PortPin_10      9U			/*~ASR~*/
