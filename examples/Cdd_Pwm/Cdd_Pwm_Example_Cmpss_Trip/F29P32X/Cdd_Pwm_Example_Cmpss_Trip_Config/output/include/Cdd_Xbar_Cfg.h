...
#define CDD_XBAR_INPUT_FLAG_API                   STD_OFF
/** \brief  Number of Input crossbar instances configured */
#define CDD_XBAR_INPUT_XBAR_CONFIGURATIONS        0U
...
#define CDD_XBAR_EPWM_XBAR_CONFIGURATIONS         1U
...
#ifndef DOXYGEN_SHOULD_SKIP_THIS
/* Design: MCAL-25820 */
/** \brief Symbolic name for CddXbarEpwmXbarInstanceConfig_0 */
#define CddXbarConf_CddXbarEpwmXbarInstanceConfig_CddXbarEpwmXbarInstanceConfig_0       0x0200			/*~ASR~*/
#endif /* DOXYGEN_SHOULD_SKIP_THIS */
