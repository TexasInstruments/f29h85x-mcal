...
#include <stdbool.h>
#include "sdk_mcal_integration.h"
#include "hw_cmpss.h"
#include "hw_memmap.h"
#include "hw_types.h"
...
{
    return (((base & BASE_ADDR_MASK) == CMPSS1_BASE_FRAME(0U)) || ((base & BASE_ADDR_MASK) == CMPSS2_BASE_FRAME(0U)) ||
            ((base & BASE_ADDR_MASK) == CMPSS3_BASE_FRAME(0U)) || ((base & BASE_ADDR_MASK) == CMPSS4_BASE_FRAME(0U)) ||
            ((base & BASE_ADDR_MASK) == CMPSS5_BASE_FRAME(0U)) || ((base & BASE_ADDR_MASK) == CMPSS6_BASE_FRAME(0U)) ||
            ((base & BASE_ADDR_MASK) == CMPSS7_BASE_FRAME(0U)) || ((base & BASE_ADDR_MASK) == CMPSS8_BASE_FRAME(0U)) ||
            ((base & BASE_ADDR_MASK) == CMPSS9_BASE_FRAME(0U)) || ((base & BASE_ADDR_MASK) == CMPSS10_BASE_FRAME(0U)) ||
            ((base & BASE_ADDR_MASK) == CMPSS11_BASE_FRAME(0U)) || ((base & BASE_ADDR_MASK) == CMPSS12_BASE_FRAME(0U)));
}
#endif
...
static inline void CMPSS_configOutputsLow(uint32_t base, uint16_t config)
{
    ...
    HWREGH(base + CMPSS_O_COMPCTL) =
        (HWREGH(base + CMPSS_O_COMPCTL) & ~(CMPSS_COMPCTL_CTRIPOUTLSEL_M | CMPSS_COMPCTL_CTRIPLSEL_M)) | (config << 8U);
}
...
static inline void CMPSS_configDAC(uint32_t base, uint16_t config)
{
    ...
    HWREGH(base + CMPSS_O_COMPDACHCTL) =
        (HWREGH(base + CMPSS_O_COMPDACHCTL) &
         ~(CMPSS_COMPDACHCTL_SWLOADSEL | CMPSS_COMPDACHCTL_SELREF | CMPSS_COMPDACHCTL_DACSOURCE)) |
        config;
}
...
//
//*****************************************************************************
static inline void CMPSS_configDACHigh(uint32_t base, uint16_t config)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static inline void CMPSS_configDACLow(uint32_t base, uint16_t config)
{
    //
    // Check the arguments.
    //
    ...
    HWREGH(base + CMPSS_O_COMPDACLCTL) = (HWREGH(base + CMPSS_O_COMPDACLCTL) & ~(CMPSS_COMPDACLCTL_DACSOURCE)) | config;
}
...
//
//*****************************************************************************
static inline void CMPSS_configureFilterInputHigh(uint32_t base, CMPSS_FilterInput filtInput)
{
    //
    // Check the arguments.
    //
    ...
    HWREGH(base + CMPSS_O_CTRIPHFILCTL) =
        (HWREGH(base + CMPSS_O_CTRIPHFILCTL) & ~CMPSS_CTRIPHFILCTL_FILTINSEL_M) | (uint16_t)filtInput;
}
...
//
//*****************************************************************************
static inline void CMPSS_configureFilterInputLow(uint32_t base, CMPSS_FilterInput filtInput)
{
    //
    // Check the arguments.
    //
    ...
    HWREGH(base + CMPSS_O_CTRIPLFILCTL) =
        (HWREGH(base + CMPSS_O_CTRIPLFILCTL) & ~CMPSS_CTRIPLFILCTL_FILTINSEL_M) | (uint16_t)filtInput;
}
...
//
//*****************************************************************************
static inline void CMPSS_setRampDirectionHigh(uint32_t base, CMPSS_RampDirection dir)
{
    //
    // Check the arguments.
    //
    ...
    HWREGH(base + CMPSS_O_COMPDACHCTL) =
        (HWREGH(base + CMPSS_O_COMPDACHCTL) & ~(CMPSS_COMPDACHCTL_RAMPDIR)) | (uint16_t)dir;
}
...
//
//*****************************************************************************
static inline void CMPSS_setRampReferenceHigh(uint32_t base, uint16_t value)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static inline uint16_t CMPSS_getRampReferenceHigh(uint32_t base)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static inline void CMPSS_setRampStepHigh(uint32_t base, uint16_t value)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static inline uint16_t CMPSS_getRampStepHigh(uint32_t base)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static inline void CMPSS_setRampDelayHigh(uint32_t base, uint16_t value)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static inline uint16_t CMPSS_getRampDelayHigh(uint32_t base)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static inline void CMPSS_setRampDirectionLow(uint32_t base, CMPSS_RampDirection dir)
{
    //
    // Check the arguments.
    //
    ...
    HWREGH(base + CMPSS_O_COMPDACLCTL) =
        (HWREGH(base + CMPSS_O_COMPDACLCTL) & ~(CMPSS_COMPDACLCTL_RAMPDIR)) | (uint16_t)dir;
}
...
//
//*****************************************************************************
static inline void CMPSS_setRampReferenceLow(uint32_t base, uint16_t value)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static inline uint16_t CMPSS_getRampReferenceLow(uint32_t base)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static inline void CMPSS_setRampStepLow(uint32_t base, uint16_t value)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static inline uint16_t CMPSS_getRampStepLow(uint32_t base)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static inline void CMPSS_setRampDelayLow(uint32_t base, uint16_t value)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static inline uint16_t CMPSS_getRampDelayLow(uint32_t base)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static inline void CMPSS_configureRampXTriggerHigh(uint32_t base, CMPSS_RampXTrigger trigger)
{
    //
    // Check the arguments.
    //
    ...
    HWREGH(base + CMPSS_O_COMPDACHCTL2) = (HWREGH(base + CMPSS_O_COMPDACHCTL2) & ~CMPSS_COMPDACHCTL2_XTRIGCFG_M) |
                                          ((uint16_t)trigger << CMPSS_COMPDACHCTL2_XTRIGCFG_S);
}
...
//
//*****************************************************************************
static inline void CMPSS_configureSyncSourceHigh(uint32_t base, uint16_t syncSource)
{
    //
    // Check the arguments.
    //
    ...
    HWREGH(base + CMPSS_O_COMPDACHCTL) = (HWREGH(base + CMPSS_O_COMPDACHCTL) & ~CMPSS_COMPDACHCTL_RAMPSOURCE_M) |
                                         ((uint16_t)(syncSource - 1U) << CMPSS_COMPDACHCTL_RAMPSOURCE_S);
}
...
//
//*****************************************************************************
static inline void CMPSS_configureSyncSourceLow(uint32_t base, uint16_t syncSource)
{
    //
    // Check the arguments.
    //
    ...
    HWREGH(base + CMPSS_O_COMPDACLCTL) = (HWREGH(base + CMPSS_O_COMPDACLCTL) & ~CMPSS_COMPDACLCTL_RAMPSOURCE_M) |
                                         ((uint16_t)(syncSource - 1U) << CMPSS_COMPDACLCTL_RAMPSOURCE_S);
}
...
//
//*****************************************************************************
static inline void CMPSS_setRampClockDividerHigh(uint32_t base, CMPSS_RampClockDiv divider)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static inline uint16_t CMPSS_getRampClockDividerHigh(uint32_t base)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static inline void CMPSS_setRampClockDividerLow(uint32_t base, CMPSS_RampClockDiv divider)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static inline uint16_t CMPSS_getRampClockDividerLow(uint32_t base)
{
    //
    // Check the arguments.
    //
...
static inline void CMPSS_configBlanking(uint32_t base, uint16_t pwmBlankSrc)
{
    ...
    HWREGH(base + CMPSS_O_COMPDACHCTL) = (HWREGH(base + CMPSS_O_COMPDACHCTL) & ~CMPSS_COMPDACHCTL_BLANKSOURCE_M) |
...
//
//*****************************************************************************
static inline void CMPSS_configBlankingSourceHigh(uint32_t base, uint16_t pwmBlankSrc)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static inline void CMPSS_enableBlankingHigh(uint32_t base)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static inline void CMPSS_disableBlankingHigh(uint32_t base)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static inline void CMPSS_configBlankingSourceLow(uint32_t base, uint16_t pwmBlankSrc)
{
    //
    // Check the arguments.
    //
    ...
    HWREGH(base + CMPSS_O_COMPDACLCTL) = (HWREGH(base + CMPSS_O_COMPDACLCTL) & ~CMPSS_COMPDACLCTL_BLANKSOURCE_M) |
...
//
//*****************************************************************************
static inline void CMPSS_enableBlankingLow(uint32_t base)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static inline void CMPSS_disableBlankingLow(uint32_t base)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static inline void CMPSS_enableDEmode(uint32_t base)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static inline void CMPSS_disableDEmode(uint32_t base)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static inline void CMPSS_selectDEACTIVESource(uint32_t base, uint16_t deactivesel)
{
    //
    // Check the arguments.
    //
    ...
    HWREGH(base + CMPSS_O_COMPDACHCTL2) = (HWREGH(base + CMPSS_O_COMPDACHCTL2) & ~(CMPSS_COMPDACHCTL2_DEACTIVESEL_M)) |
...
//
//*****************************************************************************
static inline void CMPSS_configHighDACShadowValueDE(uint32_t base, uint16_t dacval)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static inline void CMPSS_configLowDACShadowValueDE(uint32_t base, uint16_t dacval)
{
    //
    // Check the arguments.
    //
...
//
//*****************************************************************************
static inline void CMPSS_selectBlankSourceGroupHigh(uint32_t base, CMPSS_EPWMGroup group)
{
    //
    // Check the arguments.
    //
    ...
    HWREGH(base + CMPSS_O_COMPDACHCTL2) = (HWREGH(base + CMPSS_O_COMPDACHCTL2) & ~CMPSS_COMPDACHCTL2_BLANKSOURCEUSEL) |
...
//
//*****************************************************************************
static inline void CMPSS_selectBlankSourceGroupLow(uint32_t base, CMPSS_EPWMGroup group)
{
    //
    // Check the arguments.
    //
    ...
    HWREGH(base + CMPSS_O_COMPDACLCTL2) = (HWREGH(base + CMPSS_O_COMPDACLCTL2) & ~CMPSS_COMPDACLCTL2_BLANKSOURCEUSEL) |
                                          ((uint16_t)group << CMPSS_BLANKSOURCEUSEL_S);
}
...
//
//*****************************************************************************
static inline void CMPSS_selectRampSourceGroupHigh(uint32_t base, CMPSS_EPWMGroup group)
{
    //
    // Check the arguments.
    //
    ...
    HWREGH(base + CMPSS_O_COMPDACHCTL2) = (HWREGH(base + CMPSS_O_COMPDACHCTL2) & ~CMPSS_COMPDACHCTL2_RAMPSOURCEUSEL) |
...
//
//*****************************************************************************
static inline void CMPSS_selectRampSourceGroupLow(uint32_t base, CMPSS_EPWMGroup group)
{
    //
    // Check the arguments.
    //
    ...
    HWREGH(base + CMPSS_O_COMPDACLCTL2) = (HWREGH(base + CMPSS_O_COMPDACLCTL2) & ~CMPSS_COMPDACLCTL2_RAMPSOURCEUSEL) |
                                          ((uint16_t)group << CMPSS_RAMPSOURCEUSEL_S);
}
...
//
//*****************************************************************************
extern void CMPSS_configFilterHigh(uint32_t base, uint32_t samplePrescale, uint16_t sampleWindow, uint16_t threshold);
...
//
//*****************************************************************************
extern void CMPSS_configFilterLow(uint32_t base, uint32_t samplePrescale, uint16_t sampleWindow, uint16_t threshold);
...
//
//*****************************************************************************
extern void CMPSS_configRampHigh(uint32_t base, CMPSS_RampDirection rampDir, uint16_t rampRef, uint16_t stepVal,
...
//
//*****************************************************************************
extern void CMPSS_configRampLow(uint32_t base, CMPSS_RampDirection rampDir, uint16_t rampRef, uint16_t stepVal,
                                uint16_t delayVal, uint16_t pwmSyncSrc, bool useRampValShdw);
