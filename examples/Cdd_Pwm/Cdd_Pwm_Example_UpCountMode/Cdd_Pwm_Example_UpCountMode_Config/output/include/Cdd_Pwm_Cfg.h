...
#define CddPwmConf_CddPwmHwUnitConfig_0_Channel_0   ((Cdd_Pwm_ChannelType)0U)  /*~ASR~*/



/* Symbolic name of the EPWM1 output channel B */
#define CddPwmConf_CddPwmHwUnitConfig_0_Channel_1   ((Cdd_Pwm_ChannelType)1U)  /*~ASR~*//* Symbolic name for the PWM instance  2 */
...
#define CddPwmConf_CddPwmHwUnitConfig_1_Channel_0   ((Cdd_Pwm_ChannelType)2U)  /*~ASR~*/



/* Symbolic name of the EPWM2 output channel B */
#define CddPwmConf_CddPwmHwUnitConfig_1_Channel_1   ((Cdd_Pwm_ChannelType)3U)  /*~ASR~*/
