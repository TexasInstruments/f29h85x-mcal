...
#define CDD_PWM_CFG_MAJOR_VERSION           (1U)
...
#define CDD_PWM_CONFIG_PC       Cdd_Pwm_ConfigSet1
...
/* Symbolic name for the PWM instance  1 */
#define CddPwmConf_CddPwmUnit_CddPwmHwUnitConfig_0   ((Cdd_Pwm_InstanceType)0U)  /*~ASR~*/


/* Symbolic name of the EPWM1 output channel A */
#define CddPwmConf_CddPwmUnit_CddPwmHwUnitConfig_0_Channel_0   ((Cdd_Pwm_ChannelType)0U)  /*~ASR~*/


/* Symbolic name of the EPWM1 output channel B */
#define CddPwmConf_CddPwmUnit_CddPwmHwUnitConfig_0_Channel_1   ((Cdd_Pwm_ChannelType)1U)  /*~ASR~*/

/* Symbolic name for the PWM instance  2 */
#define CddPwmConf_CddPwmUnit_CddPwmHwUnitConfig_1   ((Cdd_Pwm_InstanceType)1U)  /*~ASR~*/


/* Symbolic name of the EPWM2 output channel A */
#define CddPwmConf_CddPwmUnit_CddPwmHwUnitConfig_1_Channel_0   ((Cdd_Pwm_ChannelType)2U)  /*~ASR~*/


/* Symbolic name of the EPWM2 output channel B */
#define CddPwmConf_CddPwmUnit_CddPwmHwUnitConfig_1_Channel_1   ((Cdd_Pwm_ChannelType)3U)  /*~ASR~*/
...
extern const struct Cdd_Pwm_ConfigTag Cdd_Pwm_ConfigSet1;
