...
#define CDD_XBAR_INPUT_XBAR_CONFIGURATIONS        3U
...
/** \brief Symbolic name for CddXbarInputXbarInstanceConfig_2 */
#define CddXbarConf_CddXbarInputXbarInstanceConfig_CddXbarInputXbarInstanceConfig_2      0x0002			/*~ASR~*/
#endif /* DOXYGEN_SHOULD_SKIP_THIS */
