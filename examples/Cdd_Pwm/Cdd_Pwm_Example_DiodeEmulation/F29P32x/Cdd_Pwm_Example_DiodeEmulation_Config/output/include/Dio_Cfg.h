...
/* Symbolic name for GPIO_PORT_B */
#define DioConf_DioPort_DioPort_1 ((Dio_PortType)  GPIO_PORT_B) /*~ASR~*/
...
/* Symbolic name for GPIO channel #2 DioChannel_1 */
#define DioConf_DioChannel_DioChannel_1 ((Dio_ChannelType) 2U) /*~ASR~*/
/* Symbolic name for GPIO channel #4 DioChannel_2 */
#define DioConf_DioChannel_DioChannel_2 ((Dio_ChannelType) 4U) /*~ASR~*/
/* Symbolic name for GPIO channel #5 DioChannel_3 */
#define DioConf_DioChannel_DioChannel_3 ((Dio_ChannelType) 5U) /*~ASR~*/
/* Symbolic name for GPIO channel #1 DioChannel_4 */
#define DioConf_DioChannel_DioChannel_4 ((Dio_ChannelType) 1U) /*~ASR~*/
/* Symbolic name for GPIO channel #3 DioChannel_5 */
#define DioConf_DioChannel_DioChannel_5 ((Dio_ChannelType) 3U) /*~ASR~*/
/* Symbolic name for GPIO channel #12 DioChannel_6 */
#define DioConf_DioChannel_DioChannel_6 ((Dio_ChannelType) 12U) /*~ASR~*/
/* Symbolic name for GPIO channel #13 DioChannel_7 */
#define DioConf_DioChannel_DioChannel_7 ((Dio_ChannelType) 13U) /*~ASR~*/
/* Symbolic name for GPIO channel #59 DioChannel_8 */
#define DioConf_DioChannel_DioChannel_8 ((Dio_ChannelType) 59U) /*~ASR~*/
