...
void Cdd_Pwm_Hw1TzNotification(uint16 TripZoneFlag)
{
    ...
    {
        Cdd_Pwm_ConfigureTripZoneInterrupt(CddPwmConf_CddPwmHwUnitConfig_CddPwmHwUnitConfig_1, CDD_PWM_TZ_INTERRUPT_OST,FALSE);
...
void Cdd_Pwm_Hw2TzNotification(uint16 TripZoneFlag)
{
    ...
    {
        Cdd_Pwm_ConfigureTripZoneInterrupt(CddPwmConf_CddPwmHwUnitConfig_CddPwmHwUnitConfig_2, CDD_PWM_TZ_INTERRUPT_CBC,FALSE);
...
void Cdd_Pwm_ConfigureHw()
{
    ...
    Cdd_Pwm_SetCounterCompareValue(CddPwmConf_CddPwmHwUnitConfig_CddPwmHwUnitConfig_0, CDD_PWM_COUNTER_COMPARE_A, 6000U);	
    ...
    Cdd_Pwm_SetCounterCompareValue(CddPwmConf_CddPwmHwUnitConfig_CddPwmHwUnitConfig_1, CDD_PWM_COUNTER_COMPARE_A, 3000U);	
    ...
    Cdd_Pwm_SetCounterCompareValue(CddPwmConf_CddPwmHwUnitConfig_CddPwmHwUnitConfig_2, CDD_PWM_COUNTER_COMPARE_B, 3000U);
    ...
    Cdd_Pwm_SetActionQualifierAction(CddPwmConf_CddPwmHwUnitConfig_CddPwmHwUnitConfig_2, CDD_PWM_OUTPUT_B, CDD_PWM_AQ_OUTPUT_LOW, CDD_PWM_AQ_OUTPUT_ON_TIMEBASE_DOWN_CMPB);

    Cdd_Pwm_SetTripZoneAction(CddPwmConf_CddPwmHwUnitConfig_CddPwmHwUnitConfig_2, CDD_PWM_TZ_ACTION_EVENT_TZB, CDD_PWM_TZ_ACTION_HIGH);
    Cdd_Pwm_ConfigureTripZoneSignals(CddPwmConf_CddPwmHwUnitConfig_CddPwmHwUnitConfig_2, CDD_PWM_TZ_SIGNAL_CBC1,TRUE);
    // Cdd_Pwm_ConfigureTripZoneInterrupt(CddPwmConf_CddPwmHwUnitConfig_CddPwmHwUnitConfig_2, CDD_PWM_TZ_INTERRUPT_CBC,TRUE);
    // Cdd_Pwm_ConfigureTripZoneNotification(CddPwmConf_CddPwmHwUnitConfig_CddPwmHwUnitConfig_2,TRUE);
}
...
int main()
{
    ...
    //             (Cdd_Pwm_NotificationCount[CddPwmConf_CddPwmHwUnitConfig_CddPwmHwUnitConfig_2] == 0U))
    // {
    //     McalLib_Delay(10U);
    // }
    ...
    Cdd_Pwm_SetActionQualifierAction(CddPwmConf_CddPwmHwUnitConfig_CddPwmHwUnitConfig_0, CDD_PWM_OUTPUT_A, CDD_PWM_AQ_OUTPUT_NO_CHANGE, CDD_PWM_AQ_OUTPUT_ON_TIMEBASE_UP_CMPA);
    Cdd_Pwm_SetActionQualifierAction(CddPwmConf_CddPwmHwUnitConfig_CddPwmHwUnitConfig_0, CDD_PWM_OUTPUT_A, CDD_PWM_AQ_OUTPUT_NO_CHANGE, CDD_PWM_AQ_OUTPUT_ON_TIMEBASE_DOWN_CMPA);
    ...
    Cdd_Pwm_SetActionQualifierAction(CddPwmConf_CddPwmHwUnitConfig_CddPwmHwUnitConfig_1, CDD_PWM_OUTPUT_A, CDD_PWM_AQ_OUTPUT_NO_CHANGE, CDD_PWM_AQ_OUTPUT_ON_TIMEBASE_UP_CMPA);
    Cdd_Pwm_SetActionQualifierAction(CddPwmConf_CddPwmHwUnitConfig_CddPwmHwUnitConfig_1, CDD_PWM_OUTPUT_A, CDD_PWM_AQ_OUTPUT_NO_CHANGE, CDD_PWM_AQ_OUTPUT_ON_TIMEBASE_DOWN_CMPA);
    ...
    Cdd_Pwm_SetActionQualifierAction(CddPwmConf_CddPwmHwUnitConfig_CddPwmHwUnitConfig_2, CDD_PWM_OUTPUT_A, CDD_PWM_AQ_OUTPUT_NO_CHANGE, CDD_PWM_AQ_OUTPUT_ON_TIMEBASE_UP_CMPB);
    Cdd_Pwm_SetActionQualifierAction(CddPwmConf_CddPwmHwUnitConfig_CddPwmHwUnitConfig_2, CDD_PWM_OUTPUT_A, CDD_PWM_AQ_OUTPUT_NO_CHANGE, CDD_PWM_AQ_OUTPUT_ON_TIMEBASE_DOWN_CMPB);
