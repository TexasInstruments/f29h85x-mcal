 ...
 *  Generator:  None
 *
 *  Description:  This file contains Lin Driver Demo implementation which will Send the data on Lin Bus based on three
 *                Different types of Sending data from master.
 ...
 *********************************************************************************************************************/
static inline Lin_FramePidType
Lin_GenerateParityID(Lin_FramePidType identifier)
{
...
int main(void)
{
    ...
    else
    {
        ...
        {
            AppUtils_Printf("---------------------------------------------------------------\n\r");
            AppUtils_Printf("LIN Send Data Application - Master_Response, Slave_Response, Slave_To_Slave FAILED\n");
        ...
        {
            AppUtils_Printf("---------------------------------------------------------------\n\r");
            AppUtils_Printf("LIN Send Data Application - Master_Response, Slave_Response, Slave_To_Slave PASSED\n");
            AppUtils_Printf("---------------------------------------------------------------\n\r");
        }
    }
