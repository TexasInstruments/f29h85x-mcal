...
static CONST(Mcu_LinClkConfigType, MCU_CONFIG_DATA) Mcu_LinClkCfgSet0[2] =
{
    {
    ...
    {
    /* Lin clock configuration settings */
    .Mcu_LinInstance    = ((Mcu_LINInstance) MCU_LIN_B),
    .Mcu_LinClkDiv      = ((Mcu_LINClkDivider) MCU_LINCLK_DIV_2),
    }   
};


static CONST(Mcu_LinClkConfigType, MCU_CONFIG_DATA) Mcu_LinClkCfgSet1[2] =
{
    {
    /* Lin clock configuration settings */
    .Mcu_LinInstance    = ((Mcu_LINInstance) MCU_LIN_A),
...
static CONST(Mcu_LinClkConfigType, MCU_CONFIG_DATA) Mcu_LinClkCfgSet2[2] =
{
    {
    /* Lin clock configuration settings */
    .Mcu_LinInstance    = ((Mcu_LINInstance) MCU_LIN_A),
...
static CONST(Mcu_ClockConfigType, MCU_CONFIG_DATA) Mcu_ClkCfgSet0[3] =
{
    ...
    .Mcu_LinInstancesCount      = ((uint32) 2U),
 ...
 */
CONST(Mcu_ConfigType, MCU_CONFIG_DATA) Mcu_ModuleConfiguration_0 =
{
    /* Mcu_ClockConfig */ 
