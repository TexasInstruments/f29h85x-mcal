...
static CONST( Port_PinConfigType, PORT_CONFIG_DATA) Port_PortConfigSet_PinConfig[4] =
{
   ...
   {
    /* .Port_PhysicalPinId = B15U,    Physical Pin Number*/
	.Port_PinId = (Port_PinType)68U,
    ...
    .Port_ControllerSpecific =
    {
        ...
        .Port_InitialMuxMode = (Port_PinType)PORT_PIN_68_LINB_RX,
    ...
    .Port_PinMode =
    {
        ...
        [0] = 
        {
        .Port_PinMuxMode = (Port_PinModeType)PORT_PIN_68_LINB_RX
        },
    }
   ...
   {
    /* .Port_PhysicalPinId = B16U,    Physical Pin Number*/
	.Port_PinId = (Port_PinType)67U,
    .Port_PinDirection = (Port_PinDirectionType)PORT_PIN_NA,
    .Port_DirectionChangeable = (boolean) FALSE,
    .Port_ModeChangeable = (boolean) FALSE,
    .Port_PinLevelValue = (Port_PinLevelValueType)PORT_PIN_LEVEL_NA,
    ...
    {
        .Port_AnalogMode = (Port_AnalogModeType)PORT_ANALOG_DISABLED,
        .Port_InitialMuxMode = (Port_PinType)PORT_PIN_67_LINB_TX,
    ...
    .Port_PinMode =
    {
        ...
        [0] = 
        {
        .Port_PinMuxMode = (Port_PinModeType)PORT_PIN_67_LINB_TX
        },
    }
