...
static CONST( Port_PinConfigType, PORT_CONFIG_DATA) Port_PortConfigSet_PinConfig[8] =
{
   ...
   {
    /* .Port_PhysicalPinId = D1U,    Physical Pin Number*/
	.Port_PinId = (Port_PinType)34U,
    .Port_PinDirection = (Port_PinDirectionType)PORT_PIN_OUT,
    ...
    {
        .Port_AnalogMode = (Port_AnalogModeType)PORT_ANALOG_DISABLED,
        .Port_InitialMuxMode = (Port_PinType)PORT_PIN_34_GPIO34,
    ...
    .Port_PinMode =
    {
        ...
        [0] = 
        {
        .Port_PinMuxMode = (Port_PinModeType)PORT_PIN_34_GPIO34
        },
        
        [1] = 
        {
        .Port_PinMuxMode = (Port_PinModeType)PORT_PIN_34_EPWM18_A
        },
    }
   ...
   {
    /* .Port_PhysicalPinId = D16U,    Physical Pin Number*/
	.Port_PinId = (Port_PinType)103U,
    .Port_PinDirection = (Port_PinDirectionType)PORT_PIN_OUT,
    .Port_DirectionChangeable = (boolean) TRUE,
    .Port_ModeChangeable = (boolean) TRUE,
    ...
    {
        .Port_AnalogMode = (Port_AnalogModeType)PORT_ANALOG_DISABLED,
        .Port_InitialMuxMode = (Port_PinType)PORT_PIN_103_GPIO103,
    ...
    .Port_PinMode =
    {
        ...
        [0] = 
        {
        .Port_PinMuxMode = (Port_PinModeType)PORT_PIN_103_GPIO103
        },
        
        [1] = 
        {
        .Port_PinMuxMode = (Port_PinModeType)PORT_PIN_103_EPWM8_B
        },
    }
   ...
   {
    /* .Port_PhysicalPinId = N5U,    Physical Pin Number*/
	.Port_PinId = (Port_PinType)185U,
    .Port_PinDirection = (Port_PinDirectionType)PORT_PIN_NA,
    .Port_DirectionChangeable = (boolean) FALSE,
    .Port_ModeChangeable = (boolean) FALSE,
    .Port_PinLevelValue = (Port_PinLevelValueType)PORT_PIN_LEVEL_NA,
