    ...
    Cdd_Ecap_Configset =
{
    .chCfg =
    {
        [0] =
        {
            ...
            .base_addr = (uint32)(ECAP1_BASE + (CDD_ECAP_BASEADDR_STEP*4U)), /* Base address of the channel */
            .hr_enable = (boolean)TRUE,
            .hr_base_addr = (uint32)(HRCAP5_BASE + (CDD_ECAP_HR_BASEADDR_STEP*0U)) /* Base address of the high 
                                                                                                  resolution channel */
        }
    },
};
