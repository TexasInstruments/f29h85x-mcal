...
CONST(Cdd_Pwm_ConfigType, CDD_PWM_CONFIG_DATA) Cdd_Pwm_ConfigSet1 =
{
    .hwunitcfg = 
    {        
        [0] =
        {
            ...
            //.clockdivider = (Cdd_Pwm_ClockDividerType)CDD_PWM_CLK_DIVIDER_1,//temporary
            //.highspeed_clkdiv = (Cdd_Pwm_HighSpeedClkDivType)CDD_PWM_HSCLK_DIVIDER_1,//temporary
    ...
    {        
        [0] =
        {
            ...
            //.outputchannel = (Cdd_Pwm_OutputChannelType)CDD_PWM_OUTPUT_A, //temporary
