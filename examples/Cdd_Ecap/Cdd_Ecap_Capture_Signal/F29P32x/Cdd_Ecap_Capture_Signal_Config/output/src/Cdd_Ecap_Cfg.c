 ...
 *********************************************************************************************************************/
  #if ((CDD_ECAP_SW_MAJOR_VERSION != (3U)) ||(CDD_ECAP_SW_MINOR_VERSION != (0U)))
  #error "Version numbers of Cdd_Ecap_Cfg.c and Cdd_Ecap.h are inconsistent!"
#endif

 #if ((CDD_ECAP_CFG_MAJOR_VERSION != (3U)) ||(CDD_ECAP_CFG_MINOR_VERSION != (0U)))
    ...
    Cdd_Ecap_Config =
{
    .chCfg =
    {
        [0] =
        {
            ...
            .base_addr = (uint32)ECAP1_BASE_FRAME(0U), /* Base address of the channel */
        },
        [1] =
        {
            ...
            .instanceClkMHz = 200U,
            .prescaler = (uint8)0U, /* prescale */
            .base_addr = (uint32)ECAP2_BASE_FRAME(0U), /* Base address of the channel */
        },
        [2] =
        {
            ...
            .instanceClkMHz = 200U,
            .prescaler = (uint8)0U, /* prescale */
            .base_addr = (uint32)ECAP3_BASE_FRAME(0U), /* Base address of the channel */
        },
        [3] =
        {
            ...
            .instanceClkMHz = 200U,
            .prescaler = (uint8)0U, /* prescale */
            .base_addr = (uint32)ECAP4_BASE_FRAME(0U), /* Base address of the channel */
        }
    }
};
