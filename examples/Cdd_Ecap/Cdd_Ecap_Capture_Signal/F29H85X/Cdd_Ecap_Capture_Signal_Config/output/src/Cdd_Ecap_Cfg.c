    ...
    Cdd_Ecap_Config =
{
    .chCfg =
    {
        [0] =
        {
            ...
            .base_addr = (uint32)ECAP1_BASE_FRAME(0), /* Base address of the channel */
        },
        [1] =
        {
            ...
            .instanceClkMHz = 200U,
            .prescaler = (uint8)0U, /* prescale */
            .base_addr = (uint32)ECAP2_BASE_FRAME(0), /* Base address of the channel */
        },
        [2] =
        {
            ...
            .instanceClkMHz = 200U,
            .prescaler = (uint8)0U, /* prescale */
            .base_addr = (uint32)ECAP3_BASE_FRAME(0), /* Base address of the channel */
        },
        [3] =
        {
            ...
            .instanceClkMHz = 200U,
            .prescaler = (uint8)0U, /* prescale */
            .base_addr = (uint32)ECAP4_BASE_FRAME(0), /* Base address of the channel */
        }
    }
};
