 ...
 *
 *****************************************************************************/
#define PORT_CFG_PRE_COMPILE_VARIANT         (STD_ON)
...
#define PortConf_PortPin_PortPin_2      0U			/*~ASR~*/

#define PortConf_PortPin_PortPin_3      1U			/*~ASR~*/

#define PortConf_PortPin_PortPin_6      2U			/*~ASR~*/

#define PortConf_PortPin_PortPin_7      3U			/*~ASR~*/

#define PortConf_PortPin_PortPin_4      4U			/*~ASR~*/

#define PortConf_PortPin_PortPin_5      5U			/*~ASR~*/

#define PortConf_PortPin_PortPin_8      6U			/*~ASR~*/

#define PortConf_PortPin_PortPin_9      7U			/*~ASR~*/

#define PortConf_PortPin_PortPin_0      8U			/*~ASR~*/

#define PortConf_PortPin_PortPin_1      9U			/*~ASR~*/
