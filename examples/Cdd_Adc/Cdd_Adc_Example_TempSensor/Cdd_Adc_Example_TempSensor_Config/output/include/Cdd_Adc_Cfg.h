...
#define CDD_ADC_GROUP_CNT                   ((Cdd_Adc_GroupType)2U)
...
#define CDD_ADC_PPB_CNT                     ((Cdd_Adc_PpbType)0U)
#endif
...
#define CDD_ADC_TEMPERATURE_SENSOR_ENABLE   (STD_ON)
...
extern void Cdd_Adc_Group1Notification(void);

extern void Cdd_Adc_Group2Notification(void);
