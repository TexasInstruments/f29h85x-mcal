...
CONST(struct Cdd_Adc_ConfigTag, CDD_ADC_CONFIG_DATA) Cdd_Adc_ConfigSet =
{
    ...
    {        
        [0] =
        {
            ...
            .groupend_notification = (Cdd_Adc_GroupEndNotifyType)Cdd_Adc_Group1Notification,
#endif
            .stream_numsamples = (Cdd_Adc_StreamNumSampleType)(5U),
        ...
        [1] =
        {
            ...
            .intsocsel = (Cdd_Adc_IntSocTriggerType)CDD_ADC_INT_SOC_TRIGGER_NONE,
#if(STD_ON == CDD_ADC_GRP_NOTIF_CAPABILITY_API)
            .groupend_notification = (Cdd_Adc_GroupEndNotifyType)Cdd_Adc_Group2Notification,
#endif
            .stream_numsamples = (Cdd_Adc_StreamNumSampleType)(5U),
