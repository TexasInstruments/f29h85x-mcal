...
#define CddAdcConf_CddAdcGroup_CddAdcGroup_6    ((Cdd_Adc_GroupType)6U)  /*~ASR~*/
...
/* ADC:CDD_ADCE Group0 symbolic name */
#define CddAdcConf_CddAdcGroup_CddAdcGroup_7    ((Cdd_Adc_GroupType)7U)  /*~ASR~*/
