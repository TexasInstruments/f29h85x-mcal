...
#define CDD_ADC_CONFIG_PC       Cdd_Adc_ConfigSet


/* Macro to define the number of channels configured */
#define CDD_ADC_CHN_COUNT                   ((uint8)13U)
...
#define CDD_ADC_HW_CNT                      ((uint8)5U)
...
#define CDD_ADC_PPB_CNT                     ((Cdd_Adc_PpbType)2U)
#endif
...
#define CDD_ADC_TRIG_REP_ENABLE             (STD_OFF)
...
/* Group 0 symbolic name */
#define CddAdcConf_CddAdcHwUnit_0_CddAdcGroup_0    ((Cdd_Adc_GroupType)0U)  /*~ASR~*/

/* Group 1 symbolic name */
#define CddAdcConf_CddAdcHwUnit_0_CddAdcGroup_1    ((Cdd_Adc_GroupType)1U)  /*~ASR~*/



/* PPB 0 symbolic name */
#define CddAdcConf_CddAdcHwUnit_0_CddAdcPpbConfig_0        ((Cdd_Adc_PpbType)0U) /*~ASR~*/

/* PPB 1 symbolic name */
#define CddAdcConf_CddAdcHwUnit_0_CddAdcPpbConfig_1        ((Cdd_Adc_PpbType)1U) /*~ASR~*/


/* CDD_ADCB hardware unit symbolic name */
#define CddAdcConf_CddAdcHwUnit_CddAdcHwUnit_1         ((uint8)1U) /*~ASR~*/

/* Group 2 symbolic name */
#define CddAdcConf_CddAdcHwUnit_1_CddAdcGroup_0    ((Cdd_Adc_GroupType)2U)  /*~ASR~*/

/* Group 3 symbolic name */
#define CddAdcConf_CddAdcHwUnit_1_CddAdcGroup_1    ((Cdd_Adc_GroupType)3U)  /*~ASR~*/




/* CDD_ADCC hardware unit symbolic name */
#define CddAdcConf_CddAdcHwUnit_CddAdcHwUnit_2         ((uint8)2U) /*~ASR~*/

/* Group 4 symbolic name */
#define CddAdcConf_CddAdcHwUnit_2_CddAdcGroup_0    ((Cdd_Adc_GroupType)4U)  /*~ASR~*/

/* Group 5 symbolic name */
#define CddAdcConf_CddAdcHwUnit_2_CddAdcGroup_1    ((Cdd_Adc_GroupType)5U)  /*~ASR~*/




/* CDD_ADCD hardware unit symbolic name */
#define CddAdcConf_CddAdcHwUnit_CddAdcHwUnit_3         ((uint8)3U) /*~ASR~*/

/* Group 6 symbolic name */
#define CddAdcConf_CddAdcHwUnit_3_CddAdcGroup_0    ((Cdd_Adc_GroupType)6U)  /*~ASR~*/




/* CDD_ADCE hardware unit symbolic name */
#define CddAdcConf_CddAdcHwUnit_CddAdcHwUnit_4         ((uint8)4U) /*~ASR~*/

/* Group 7 symbolic name */
#define CddAdcConf_CddAdcHwUnit_4_CddAdcGroup_0    ((Cdd_Adc_GroupType)7U)  /*~ASR~*/
...
#define CddAdcConf_CddAdcGlobalSwTrigger_CddAdcGlobalSwTrigger_0   ((Cdd_Adc_GlbTrigType)0U) /*~ASR~*/


/* Global software trigger symbolic names */
#define CddAdcConf_CddAdcGlobalSwTrigger_CddAdcGlobalSwTrigger_1   ((Cdd_Adc_GlbTrigType)1U) /*~ASR~*/


/* Global software trigger symbolic names */
#define CddAdcConf_CddAdcGlobalSwTrigger_CddAdcGlobalSwTrigger_2   ((Cdd_Adc_GlbTrigType)2U) /*~ASR~*/
...
#define CDD_ADCA_INT2_ISR_CAT1_RTINT



#define CDD_ADCA_EVTINT_ENABLE

#define CDD_ADCA_EVTINT_ISR_CAT1_RTINT

#define CDD_ADCB_INT1_ENABLE

#define CDD_ADCB_INT1_ISR_CAT1_INT

#define CDD_ADCB_INT2_ENABLE

#define CDD_ADCB_INT2_ISR_CAT1_RTINT


#define CDD_ADCC_INT1_ENABLE

#define CDD_ADCC_INT1_ISR_CAT1_INT

#define CDD_ADCC_INT2_ENABLE

#define CDD_ADCC_INT2_ISR_CAT1_RTINT
...
#define CDD_ADCE_INT1_ENABLE

#define CDD_ADCE_INT1_ISR_CAT1_INT
...
typedef enum
{
    ...
    CDD_ADC_RESOLUTION_16BIT = 0x40U     /* 16-bit conversion resolution */
...
extern const struct Cdd_Adc_ConfigTag Cdd_Adc_ConfigSet;
...
extern void Cdd_Adc_ADCA_Grp0NotifFunc(void);

extern void Cdd_Adc_ADCA_Grp1NotifFunc(void);

extern void Cdd_Adc_ADCB_Grp0NotifFunc(void);

extern void Cdd_Adc_ADCB_Grp1NotifFunc(void);

extern void Cdd_Adc_ADCC_Grp0NotifFunc(void);

extern void Cdd_Adc_ADCC_Grp1NotifFunc(void);

extern void Cdd_Adc_ADCD_GrpNotifFunc(void);

extern void Cdd_Adc_ADCE_GrpNotifFunc(void);



extern void Cdd_Adc_TripLowNotification(void);

extern void Cdd_Adc_TripHighNotification(void);
