...
static CONST( Port_PinConfigType, PORT_CONFIG_DATA) Port_PortConfigSet_PinConfig[9] =
{
   ...
   {
    /* .Port_PhysicalPinId = M1U,    Physical Pin Number*/
	.Port_PinId = (Port_PinType)162U,
    .Port_PinDirection = (Port_PinDirectionType)PORT_PIN_NA,
    .Port_DirectionChangeable = (boolean) FALSE,
    .Port_ModeChangeable = (boolean) FALSE,
    .Port_PinLevelValue = (Port_PinLevelValueType)PORT_PIN_LEVEL_NA,
   ...
   {
    /* .Port_PhysicalPinId = P4U,    Physical Pin Number*/
	.Port_PinId = (Port_PinType)203U,
    .Port_PinDirection = (Port_PinDirectionType)PORT_PIN_NA,
    .Port_DirectionChangeable = (boolean) FALSE,
    .Port_ModeChangeable = (boolean) FALSE,
    .Port_PinLevelValue = (Port_PinLevelValueType)PORT_PIN_LEVEL_NA,
   ...
   {
    /* .Port_PhysicalPinId = J5U,    Physical Pin Number*/
	.Port_PinId = (Port_PinType)230U,
    .Port_PinDirection = (Port_PinDirectionType)PORT_PIN_NA,
    .Port_DirectionChangeable = (boolean) FALSE,
    .Port_ModeChangeable = (boolean) FALSE,
    .Port_PinLevelValue = (Port_PinLevelValueType)PORT_PIN_LEVEL_NA,
   ...
   {
    /* .Port_PhysicalPinId = M8U,    Physical Pin Number*/
	.Port_PinId = (Port_PinType)236U,
    .Port_PinDirection = (Port_PinDirectionType)PORT_PIN_NA,
    .Port_DirectionChangeable = (boolean) FALSE,
    .Port_ModeChangeable = (boolean) FALSE,
    .Port_PinLevelValue = (Port_PinLevelValueType)PORT_PIN_LEVEL_NA,
...
const struct Port_ConfigType_s Port_PortConfigSet = 
{
    ...
    .Port_NumberOfPortPins = (Port_PinType)9U
};
