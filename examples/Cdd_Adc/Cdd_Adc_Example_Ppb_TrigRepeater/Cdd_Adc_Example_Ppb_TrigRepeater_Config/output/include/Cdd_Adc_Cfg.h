...
#define CddAdcConf_CddAdcHwUnit_0_CddAdcGroup_2    ((Cdd_Adc_GroupType)2U)  /*~ASR~*/

/* Group 3 symbolic name */
#define CddAdcConf_CddAdcHwUnit_0_CddAdcGroup_3    ((Cdd_Adc_GroupType)3U)  /*~ASR~*/
...
/* PPB 2 symbolic name */
#define CddAdcConf_CddAdcHwUnit_0_CddAdcPpbConfig_2        ((Cdd_Adc_PpbType)2U) /*~ASR~*/
...
#define CddAdcConf_CddAdcHwUnit_1_CddAdcGroup_0    ((Cdd_Adc_GroupType)4U)  /*~ASR~*/

/* Group 5 symbolic name */
#define CddAdcConf_CddAdcHwUnit_1_CddAdcGroup_1    ((Cdd_Adc_GroupType)5U)  /*~ASR~*/
