...
CONST(struct Cdd_Adc_ConfigTag, CDD_ADC_CONFIG_DATA) Cdd_Adc_ConfigSet =
{
    .hwunitcfg =
    {
        ...
        [0] =
        {
            ...
            .socpriority = (Cdd_Adc_SocPriorityType)5, 
    ...
    {                
        [0] =  
        {
            ...
            .ppbresconfig = (uint16)((0x0000U) | ((1U)<<8U) | ((0U)<<7U) | ((1U)<<6U) | ((0U)<<5U)),
        ...
        [2] =  
        {
            ...
            .ppb_caloffset = (uint32)(0U),
            .ppb_refoffset = (uint32)(0U),
            .ppbresconfig = (uint16)((0x0000U) | ((0U)<<8U) | ((0U)<<7U) | ((0U)<<6U) | ((1U)<<5U)),
