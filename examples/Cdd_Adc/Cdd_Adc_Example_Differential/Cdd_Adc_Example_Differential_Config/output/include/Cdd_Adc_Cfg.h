...
#define CDD_ADC_GROUP_CNT                   ((Cdd_Adc_GroupType)4U)
...
/* Hardware trigger Api macro */
#define CDD_ADC_SET_RESOLUTION_API          (STD_ON)
...
#define CddAdcConf_CddAdcHwUnit_1_CddAdcGroup_0    ((Cdd_Adc_GroupType)1U)  /*~ASR~*/



/* PPB 1 symbolic name */
#define CddAdcConf_CddAdcHwUnit_1_CddAdcPpbConfig_0        ((Cdd_Adc_PpbType)1U) /*~ASR~*/
...
#define CddAdcConf_CddAdcHwUnit_2_CddAdcGroup_0    ((Cdd_Adc_GroupType)2U)  /*~ASR~*/

/* Group 3 symbolic name */
#define CddAdcConf_CddAdcHwUnit_2_CddAdcGroup_1    ((Cdd_Adc_GroupType)3U)  /*~ASR~*/



/* PPB 2 symbolic name */
#define CddAdcConf_CddAdcHwUnit_2_CddAdcPpbConfig_0        ((Cdd_Adc_PpbType)2U) /*~ASR~*/
