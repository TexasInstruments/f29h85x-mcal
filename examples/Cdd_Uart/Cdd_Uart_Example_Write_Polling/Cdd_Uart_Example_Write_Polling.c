 ...
 *                 in polling mode,  showcasing its capabilities in transmitting data.
 *                 The program initializes the UART instance, writes data to the transmit buffer,
 *                 and waits for the transmission to complete with the help of scheduled function Cdd_Uart_MainFunction_Write.
 * 
 ...
 *  Cdd_Uart_Deinit()
 *  Verification of Cdd_Uart write polling functionality
 *  The program writes data to the transmit buffer and verifies that the transmission is completed,
 *  demonstrating the reliability and functionality of the Cdd_Uart driver in polling mode.
 *
