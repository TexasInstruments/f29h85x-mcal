...
#define CDD_UART_CFG_MAJOR_VERSION           (1U)
...
#define CDD_UART_INIT_CONFIG_PC                     Cdd_Uart_CddUartConfigSet
...
#define CDD_UART3_ENABLE
#define CDD_UART3_ISR_CAT1_INT
...
extern CONST(struct Cdd_Uart_ConfigTag, CDD_UART_CONFIG_DATA) Cdd_Uart_CddUartConfigSet;
