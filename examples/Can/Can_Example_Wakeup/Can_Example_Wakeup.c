 ...
 *  hardware objects for Tx and 2 hardware objects in Rx. validate the receive data with respect
 *  to the transmit data, below are sets on this example code.
 ...
 *                11. If wakeup event is detected then read rx indication,rx indication should be
 *                    zero.
 *********************************************************************************************************************/
