...
#define MCAL_LIB_REG_MF_READ32(regAddr, REG_FIELD) \
    (McalLib_RegMFReadRaw32((uint32)(regAddr), (uint32)REG_FIELD##_MASK, (uint32)REG_FIELD##_SHIFT))
...
#define MCAL_LIB_REG_MF_WRITE32(regAddr, REG_FIELD, fieldVal)                                        \
    (McalLib_RegMFWriteRaw32((uint32)(regAddr), (uint32)REG_FIELD##_MASK, (uint32)REG_FIELD##_SHIFT, \
                             (uint32)(fieldVal)))
 ...
 *
 ******************************************************************************/
#define MCAL_LIB_REG_READ32(regAddr) (uint32)(McalLib_RegReadRaw32((uint32)(regAddr)))
 ...
 *
 ******************************************************************************/
#define MCAL_LIB_REG_WRITE32(regAddr, value) (McalLib_RegWriteRaw32((uint32)(regAddr), (uint32)(value)))
...
#define MCAL_LIB_REG_FIELD_SET32(regVal, REG_FIELD, fieldVal)      \
    ((regVal) = ((regVal) & (uint32)(~(uint32)REG_FIELD##_MASK)) | \
                ((((uint32)(fieldVal)) << (uint32)REG_FIELD##_SHIFT) & (uint32)REG_FIELD##_MASK))
 ...
 *
 ******************************************************************************/
#define MCAL_LIB_REG_FIELD_GET(regVal, REG_FIELD) (((regVal) & (uint32)REG_FIELD##_MASK) >> (uint32)REG_FIELD##_SHIFT)
/*********************************************************************************************************************
 ...
 *
 ******************************************************************************/
LOCAL_INLINE FUNC(uint16, MCAL_LIB_CODE) McalLib_RegMFReadRaw16(uint32 addr, uint16 mask, uint16 shift);
 ...
 *
 ******************************************************************************/
LOCAL_INLINE FUNC(void, MCAL_LIB_CODE) McalLib_RegMFWriteRaw16(uint32 addr, uint16 mask, uint16 shift, uint16 value);
 ...
 *
 ******************************************************************************/
LOCAL_INLINE FUNC(void, MCAL_LIB_CODE) McalLib_RegMFWriteRaw32(uint32 addr, uint32 mask, uint32 shift, uint32 value);
 ...
 *
 ******************************************************************************/
LOCAL_INLINE FUNC(uint32, MCAL_LIB_CODE) McalLib_RegMFReadRaw32(uint32 addr, uint32 mask, uint32 shift);
 ...
 *
 ******************************************************************************/
LOCAL_INLINE FUNC(void, MCAL_LIB_CODE) McalLib_RegBitClear32(uint32 addr, uint32 mask);
 ...
 *
 ******************************************************************************/
LOCAL_INLINE FUNC(void, MCAL_LIB_CODE) McalLib_RegBitSet32(uint32 addr, uint32 mask);
/*********************************************************************************************************************
