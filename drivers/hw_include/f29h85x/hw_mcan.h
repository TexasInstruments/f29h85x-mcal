...
#define MCAN_O_SS_CTRL                          0x4U    // MCAN Subsystem Control Register
#define MCAN_O_SS_STAT                          0x8U    // MCAN Subsystem Status Register
#define MCAN_O_SS_ICS                           0xCU    // MCAN Subsystem Interrupt Clear Shadow
                                                        // Register
#define MCAN_O_SS_IRS                           0x10U   // MCAN Subsystem Interrupt Raw Satus
                                                        // Register
#define MCAN_O_SS_IECS                          0x14U   // MCAN Subsystem Interrupt Enable Clear
                                                        // Shadow Register
#define MCAN_O_SS_IE                            0x18U   // MCAN Subsystem Interrupt Enable Register
#define MCAN_O_SS_IES                           0x1CU   // MCAN Subsystem Interrupt Enable Status
#define MCAN_O_SS_EOI                           0x20U   // MCAN Subsystem End of Interrupt
#define MCAN_O_SS_EXT_TS_PRESCALER              0x24U   // MCAN Subsystem External Timestamp
                                                        // Prescaler 0
#define MCAN_O_SS_EXT_TS_UNSERVICED_INTR_CNTR   0x28U   // MCAN Subsystem External Timestamp
                                                        // Unserviced Interrupts Counter

#define MCAN_O_CREL     0x0U    // MCAN Core Release Register
#define MCAN_O_ENDN     0x4U    // MCAN Endian Register
#define MCAN_O_DBTP     0xCU    // MCAN Data Bit Timing and Prescaler Register
#define MCAN_O_TEST     0x10U   // MCAN Test Register
#define MCAN_O_RWD      0x14U   // MCAN RAM Watchdog
#define MCAN_O_CCCR     0x18U   // MCAN CC Control Register
#define MCAN_O_NBTP     0x1CU   // MCAN Nominal Bit Timing and Prescaler Register
#define MCAN_O_TSCC     0x20U   // MCAN Timestamp Counter Configuration
#define MCAN_O_TSCV     0x24U   // MCAN Timestamp Counter Value
#define MCAN_O_TOCC     0x28U   // MCAN Timeout Counter Configuration
#define MCAN_O_TOCV     0x2CU   // MCAN Timeout Counter Value
#define MCAN_O_ECR      0x40U   // MCAN Error Counter Register
#define MCAN_O_PSR      0x44U   // MCAN Protocol Status Register
#define MCAN_O_TDCR     0x48U   // MCAN Transmitter Delay Compensation Register
#define MCAN_O_IR       0x50U   // MCAN Interrupt Register
#define MCAN_O_IE       0x54U   // MCAN Interrupt Enable
#define MCAN_O_ILS      0x58U   // MCAN Interrupt Line Select
#define MCAN_O_ILE      0x5CU   // MCAN Interrupt Line Enable
#define MCAN_O_GFC      0x80U   // MCAN Global Filter Configuration
#define MCAN_O_SIDFC    0x84U   // MCAN Standard ID Filter Configuration
#define MCAN_O_XIDFC    0x88U   // MCAN Extended ID Filter Configuration
#define MCAN_O_XIDAM    0x90U   // MCAN Extended ID and Mask
#define MCAN_O_HPMS     0x94U   // MCAN High Priority Message Status
#define MCAN_O_NDAT1    0x98U   // MCAN New Data 1
#define MCAN_O_NDAT2    0x9CU   // MCAN New Data 2
#define MCAN_O_RXF0C    0xA0U   // MCAN Rx FIFO 0 Configuration
#define MCAN_O_RXF0S    0xA4U   // MCAN Rx FIFO 0 Status
#define MCAN_O_RXF0A    0xA8U   // MCAN Rx FIFO 0 Acknowledge
#define MCAN_O_RXBC     0xACU   // MCAN Rx Buffer Configuration
#define MCAN_O_RXF1C    0xB0U   // MCAN Rx FIFO 1 Configuration
#define MCAN_O_RXF1S    0xB4U   // MCAN Rx FIFO 1 Status
#define MCAN_O_RXF1A    0xB8U   // MCAN Rx FIFO 1 Acknowledge
#define MCAN_O_RXESC    0xBCU   // MCAN Rx Buffer / FIFO Element Size Configuration
#define MCAN_O_TXBC     0xC0U   // MCAN Tx Buffer Configuration
#define MCAN_O_TXFQS    0xC4U   // MCAN Tx FIFO / Queue Status
#define MCAN_O_TXESC    0xC8U   // MCAN Tx Buffer Element Size Configuration
#define MCAN_O_TXBRP    0xCCU   // MCAN Tx Buffer Request Pending
#define MCAN_O_TXBAR    0xD0U   // MCAN Tx Buffer Add Request
#define MCAN_O_TXBCR    0xD4U   // MCAN Tx Buffer Cancellation Request
#define MCAN_O_TXBTO    0xD8U   // MCAN Tx Buffer Transmission Occurred
#define MCAN_O_TXBCF    0xDCU   // MCAN Tx Buffer Cancellation Finished
#define MCAN_O_TXBTIE   0xE0U   // MCAN Tx Buffer Transmission Interrupt Enable
#define MCAN_O_TXBCIE   0xE4U   // MCAN Tx Buffer Cancellation Finished Interrupt Enable
#define MCAN_O_TXEFC    0xF0U   // MCAN Tx Event FIFO Configuration
#define MCAN_O_TXEFS    0xF4U   // MCAN Tx Event FIFO Status
#define MCAN_O_TXEFA    0xF8U   // MCAN Tx Event FIFO Acknowledge

#define MCAN_O_ERR_REV               0x0U     // MCAN Error Aggregator Revision Register
#define MCAN_O_ERR_VECTOR            0x8U     // MCAN ECC Vector Register
#define MCAN_O_ERR_STAT              0xCU     // MCAN Error Misc Status
#define MCAN_O_ERR_WRAP_REV          0x10U    // MCAN ECC Wrapper Revision Register
#define MCAN_O_ERR_CTRL              0x14U    // MCAN ECC Control
#define MCAN_O_ERR_ERR_CTRL1         0x18U    // MCAN ECC Error Control 1 Register
#define MCAN_O_ERR_ERR_CTRL2         0x1CU    // MCAN ECC Error Control 2 Register
#define MCAN_O_ERR_ERR_STAT1         0x20U    // MCAN ECC Error Status 1 Register
#define MCAN_O_ERR_ERR_STAT2         0x24U    // MCAN ECC Error Status 2 Register
#define MCAN_O_ERR_ERR_STAT3         0x28U    // MCAN ECC Error Status 3 Register
#define MCAN_O_ERR_SEC_EOI           0x3CU    // MCAN Single Error Corrected End of Interrupt
                                              // Register
#define MCAN_O_ERR_SEC_STATUS        0x40U    // MCAN Single Error Corrected Interrupt Status
                                              // Register
#define MCAN_O_ERR_SEC_ENABLE_SET    0x80U    // MCAN Single Error Corrected Interrupt Enable Set
                                              // Register
#define MCAN_O_ERR_SEC_ENABLE_CLR    0xC0U    // MCAN Single Error Corrected Interrupt Enable Clear
                                              // Register
#define MCAN_O_ERR_DED_EOI           0x13CU   // MCAN Double Error Detected End of Interrupt
                                              // Register
#define MCAN_O_ERR_DED_STATUS        0x140U   // MCAN Double Error Detected Interrupt Status
                                              // Register
#define MCAN_O_ERR_DED_ENABLE_SET    0x180U   // MCAN Double Error Detected Interrupt Enable Set
                                              // Register
#define MCAN_O_ERR_DED_ENABLE_CLR    0x1C0U   // MCAN Double Error Detected Interrupt Enable Clear
                                              // Register
#define MCAN_O_ERR_AGGR_ENABLE_SET   0x200U   // MCAN Error Aggregator Enable Set Register
#define MCAN_O_ERR_AGGR_ENABLE_CLR   0x204U   // MCAN Error Aggregator Enable Clear Register
#define MCAN_O_ERR_AGGR_STATUS_SET   0x208U   // MCAN Error Aggregator Status Set Register
#define MCAN_O_ERR_AGGR_STATUS_CLR   0x20CU   // MCAN Error Aggregator Status Clear Register
