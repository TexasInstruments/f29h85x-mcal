...
#define ESM_SYS_O_RAW(i)                     (0x400U + ((i) * 32))   // (0 <= i < 8) Error Group N
                                                                     // Event Raw Status/Set Register
#define ESM_SYS_O_STS(i)                     (0x404U + ((i) * 32))   // (0 <= i < 8) Error Group N
                                                                     // Interrupt Enable Status/Clear
                                                                     // Register
#define ESM_SYS_O_INTR_EN_SET(i)             (0x408U + ((i) * 32))   // (0 <= i < 8) Error Group N
                                                                     // Interrupt Enable Set Register
#define ESM_SYS_O_INTR_EN_CLR(i)             (0x40CU + ((i) * 32))   // (0 <= i < 8) Error Group N
                                                                     // Interrupt Enabled Clear Register
#define ESM_SYS_O_INT_PRIO(i)                (0x410U + ((i) * 32))   // (0 <= i < 8) Error Group N
                                                                     // Interrupt Priority Register
#define ESM_SYS_O_PIN_EN_SET(i)              (0x414U + ((i) * 32))   // (0 <= i < 8) Error Group N
                                                                     // Error Pin Influence Set Register
#define ESM_SYS_O_PIN_EN_CLR(i)              (0x418U + ((i) * 32))   // (0 <= i < 8) Error Group N
                                                                     // Error Pin Influence Clear Register
#define ESM_SYS_O_CRIT_EN_SET(i)             (0x800U + ((i) * 32))   // (0 <= i < 8) Error Group N
                                                                     // Critical Priority Interrupt
                                                                     // Influence Set Register
#define ESM_SYS_O_CRIT_EN_CLR(i)             (0x804U + ((i) * 32))   // (0 <= i < 8) Error Group N
                                                                     // Critical Priority Interrupt
