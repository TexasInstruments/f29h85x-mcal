...
#define PIPE_O_INT_GRP_MASK               0x4U                       // Interrupt group mask
                                                                     // regsiter
#define PIPE_O_GLOBAL_EN                  0x8U                       // Global enabe for INT and
                                                                     // RTINT
...
#define PIPE_O_MEM_INIT                   0x44U                      // PIPE vector memory
                                                                     // initalization register
#define PIPE_O_MEM_INIT_STS               0x48U                      // PIPE memory initialization
                                                                     // status register
#define PIPE_O_INT_SEC_STS                0x4CU                      // Interrupt secuirty status
                                                                     // register
#define PIPE_O_INT_SEC_CLR                0x50U                      // Interrupt secuirty clear
                                                                     // register
...
#define PIPE_GLOBAL_EN_KEY_M      0xFFFF0000U   // key to enable wirte to ENABLE filed
...
#define PIPE_MEM_ECC_DIAG_MEM_SIC_DIAG_EN      0x2U          // Memory safe interconnect
                                                             // diagnostics enable
#define PIPE_MEM_ECC_DIAG_WRITE_ENABLE_KEY_S   16U
#define PIPE_MEM_ECC_DIAG_WRITE_ENABLE_KEY_M   0xFFFF0000U   // key to enable wirte to lower [15:0]
                                                             // bit fileds
#define PIPE_MEM_ECC_DIAG_WRITE_ENABLE_KEY     0x5A5A0000U   // Key Value
...
#define PIPE_MEM_INIT_INIT_M               0x3U          // Memory initalization start
#define PIPE_MEM_INIT_WRITE_ENABLE_KEY_S   16U
#define PIPE_MEM_INIT_WRITE_ENABLE_KEY_M   0xFFFF0000U   // key to enable wirte to lower [15:0] bit
                                                         // fileds
#define PIPE_MEM_INIT_WRITE_ENABLE_KEY     0x5A5A0000U   // Key Value
...
//
//*************************************************************************************************
#define PIPE_LOCK_LINK_LOCK            0x1U          // Lock bit for link fileds
...
#define PIPE_LOCK_WRITE_ENABLE_KEY_S   16U
#define PIPE_LOCK_WRITE_ENABLE_KEY_M   0xFFFF0000U   // key to enable wirte to lower [15:0] bit
                                                     // fileds
#define PIPE_LOCK_WRITE_ENABLE_KEY     0x5A5A0000U   // Key Value
...
//
//*************************************************************************************************
#define PIPE_COMMIT_LINK_COMMIT          0x1U          // Commit bit for link fileds
...
#define PIPE_COMMIT_WRITE_ENABLE_KEY_S   16U
#define PIPE_COMMIT_WRITE_ENABLE_KEY_M   0xFFFF0000U   // key to enable wirte to lower [15:0] bit
                                                       // fileds
#define PIPE_COMMIT_WRITE_ENABLE_KEY     0x5A5A0000U   // Key Value
...
#define PIPE_TASK_CTRL_ACTIVE_CONTEXT_ID_M   0x3U          // Active context ID for PIPE
                                                           // arbitration.
#define PIPE_TASK_CTRL_SUP_IGN_INTE_EN       0x100U        // Enable for Supervisor ignore INTE
                                                           // control.
#define PIPE_TASK_CTRL_WRITE_ENABLE_KEY_S    16U
#define PIPE_TASK_CTRL_WRITE_ENABLE_KEY_M    0xFFFF0000U   // key to enable wirte to lower [15:0]
                                                           // bit fileds
#define PIPE_TASK_CTRL_WRITE_ENABLE_KEY      0xCAFE0000U   // Key Value
...
#define PIPE_BOOT_LINK_CTRL_WRITE_ENABLE_KEY_S   16U
#define PIPE_BOOT_LINK_CTRL_WRITE_ENABLE_KEY_M   0xFFFF0000U   // key to enable wirte to lower
                                                               // [15:0] bit fileds
#define PIPE_BOOT_LINK_CTRL_WRITE_ENABLE_KEY     0xFACE0000U   // Key Value
...
#define PIPE_INT_VECT_MAPPING_LFU_INT_VECT_MAPPING_M   0x3U          // Interrupt vector mapping to
                                                                     // PPB for LFU support
#define PIPE_INT_VECT_MAPPING_WRITE_ENABLE_KEY_S       16U
#define PIPE_INT_VECT_MAPPING_WRITE_ENABLE_KEY_M       0xFFFF0000U   // key to enable wirte to
                                                                     // lower [15:0] bit fileds
#define PIPE_INT_VECT_MAPPING_WRITE_ENABLE_KEY         0xCAFE0000U   // Key Value
...
#define PIPE_ALL_FLAG_CLR_ALL_FLAG_CLR_M       0x3U          // Clears the Flags for all the
                                                             // interrupt lines.
#define PIPE_ALL_FLAG_CLR_WRITE_ENABLE_KEY_S   16U
#define PIPE_ALL_FLAG_CLR_WRITE_ENABLE_KEY_M   0xFFFF0000U   // key to enable wirte to lower [15:0]
                                                             // bit fileds
#define PIPE_ALL_FLAG_CLR_WRITE_ENABLE_KEY     0xFEED0000U   // Key Value
...
//
//*************************************************************************************************
#define PIPE_REG_PARITY_DIAG_PARITY_DIAG_DATA_S   0U
#define PIPE_REG_PARITY_DIAG_PARITY_DIAG_DATA_M   0xFU   // Diagnostics data
...
#define PIPE_REG_PARITY_DIAG_ASSERT_WRITE_ENABLE_KEY_S   16U
#define PIPE_REG_PARITY_DIAG_ASSERT_WRITE_ENABLE_KEY_M   0xFFFF0000U   // key to enable wirte to
                                                                       // lower [15:0] bit fileds
...
#define PIPE_REG_PARITY_CHECK_KEY_M    0xFFFF0000U   // Write Key
...
#define PIPE_REG_PARITY_READ_KEY_M              0xFFFF0000U   // Write Key
...
#define PIPE_INT_CTL_H_FLAG_CLR            0x2U   // INT_FLAG_ SW clear bit
#define PIPE_INT_CTL_H_OVERFLOW_FLAG_CLR   0x4U   // INT_OVERFLOW_FLAG_ SW clear bit
...
#define PIPE_INT_LINK_OWNER_API_LINK_EN    0x100U   // Access protection inheritance link en for
                                                    // INT
...
#define PIPE_INT_LINK_OWNER_LFU_OWNER_LINK_M   0xFU     // Link owner for INT
...
#define PIPE_INT_LINK_OWNER_LFU_API_LINK_M     0xF0U    // Access protection inheritance link for
                                                        // INT
#define PIPE_INT_LINK_OWNER_LFU_API_LINK_EN    0x100U   // Access protection inheritance link en
                                                        // for INT
...
//
//*************************************************************************************************
#define PIPE_SELFTEST_DIAG_STATUS_CLR_DIAG_TEST_DONE   0x2U   // Clear selftest done status flag
