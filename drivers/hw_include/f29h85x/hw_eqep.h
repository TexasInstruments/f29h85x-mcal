...
#define EQEP_O_QWDPRD         0x26U   // QEP Watchdog Period
#define EQEP_O_QDECCTL        0x28U   // Quadrature Decoder Control
#define EQEP_O_QEPCTL         0x2AU   // QEP Control
#define EQEP_O_QCAPCTL        0x2CU   // Qaudrature Capture Control
#define EQEP_O_QPOSCTL        0x2EU   // Position Compare Control
#define EQEP_O_QEINT          0x30U   // QEP Interrupt Control
#define EQEP_O_QFLG           0x32U   // QEP Interrupt Flag
#define EQEP_O_QCLR           0x34U   // QEP Interrupt Clear
#define EQEP_O_QFRC           0x36U   // QEP Interrupt Force
#define EQEP_O_QEPSTS         0x38U   // QEP Status
#define EQEP_O_QCTMR          0x3AU   // QEP Capture Timer
#define EQEP_O_QCPRD          0x3CU   // QEP Capture Period
#define EQEP_O_QCTMRLAT       0x3EU   // QEP Capture Latch
#define EQEP_O_QCPRDLAT       0x40U   // QEP Capture Period Latch
