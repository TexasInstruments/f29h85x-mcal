 ...
 *  Generator:    None
 *
 *  Description:  This file contains the UART MCAL driver private API's definitions specific to device
 *********************************************************************************************************************/
 ...
 *
 *****************************************************************************/
static FUNC(void, CDD_UART_CODE) Cdd_Uart_CfgCtl(P2VAR(Cdd_Uart_ObjectType, AUTOMATIC, CDD_UART_APPL_DATA) UartHwUnitObj);
 ...
 *
 *****************************************************************************/
static FUNC(void, CDD_UART_CODE) Cdd_Uart_CfgBrd(P2VAR(Cdd_Uart_ObjectType, AUTOMATIC, CDD_UART_APPL_DATA) UartHwUnitObj);
 ...
 *
 *****************************************************************************/
static FUNC(void, CDD_UART_CODE) Cdd_Uart_CfgLineCtl(P2VAR(Cdd_Uart_ObjectType, AUTOMATIC, CDD_UART_APPL_DATA) UartHwUnitObj);
...
static FUNC(void, CDD_UART_CODE) Cdd_Uart_CfgBrd(P2VAR(Cdd_Uart_ObjectType, AUTOMATIC, CDD_UART_APPL_DATA) UartHwUnitObj)
{
    ...
    /*
     *  BRD = (IBRD + FBRD) = UartSysClk/(ClkDiv * BaudRate), ClkDiv = 16 if HSE = 0, ClkDiv = 8 if HSE = 1
     *  IBRD is 16 bits and FBRD is 6 bits
     *  'uartFbrDiv' is fixed point with 6 binary points hence it is multiplied by 64
     */
