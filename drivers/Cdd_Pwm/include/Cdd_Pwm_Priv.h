...
*
*********************************************************************************************************************/
FUNC(void, CDD_PWM_CODE) Cdd_Pwm_NotificationEnable(VAR(Cdd_Pwm_ChannelType, AUTOMATIC) Channel,
...
*
*********************************************************************************************************************/
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetCounterCompareShadowLoadMode(VAR(uint32,AUTOMATIC) Base,
...
*
*********************************************************************************************************************/
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetTimeBasePeriod(VAR(uint32,AUTOMATIC) Base,
...
*
*********************************************************************************************************************/
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetActionQualifierShadowLoadMode(VAR(uint32,AUTOMATIC) Base,
...
*
*********************************************************************************************************************/
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetClockPrescaler(VAR(uint32,AUTOMATIC) Base,
...
*
*********************************************************************************************************************/
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivDisableCounterCompareShadowLoadMode(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                         VAR(Cdd_Pwm_CounterCompareModuleType,AUTOMATIC) CompModule);
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivConfigureGlobalLoadRegisters(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                        VAR(uint16,AUTOMATIC) LoadRegister,
                                                            VAR(boolean,AUTOMATIC) Select);
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetXCmpShadowRegValue(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                            VAR(Cdd_Pwm_XCompareRegType,AUTOMATIC) XCmpReg,
...
*
*********************************************************************************************************************/
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSelectMinimumDeadBandBlockingSignal(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                                VAR(Cdd_Pwm_OutputChannelType,AUTOMATIC) OutputChannel,
