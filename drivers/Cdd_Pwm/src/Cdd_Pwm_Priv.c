...
LOCAL_INLINE FUNC(void,CDD_PWM_CODE) Cdd_Pwm_SetActionQualifierAction(uint32 Base,
                Cdd_Pwm_OutputChannelType ChannelType,Cdd_Pwm_ActionQualifierOutputType Output,
...
#if (STD_ON == CDD_PWM_ADVANCED_MODE_API)
LOCAL_INLINE FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivClearTripZoneFlagRegister(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId)
{
...
LOCAL_INLINE FUNC(void,CDD_PWM_CODE) Cdd_Pwm_SetCounterCompareValue(uint32 Base,
                                                        Cdd_Pwm_OutputChannelType OutputChannel, uint16 CompareCount)
{
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetTimeBaseCounterMode(VAR(uint32,AUTOMATIC) Base,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetActionQualifierShadowLoadMode(uint32 Base,
                                                    ...
                                                    VAR(Cdd_Pwm_ActionQualifierLoadModeType,AUTOMATIC) LoadMode)
{
    ...
    HWREGH(Base + EPWM_O_AQCTL) = (((HWREGH(Base + EPWM_O_AQCTL) & 
                                    ...
                                    (0x3U << syncoffset)))) |
                                    (0x1U << shadowoffset)) |
                                    ((((uint16)LoadMode >> 2U) << syncoffset) | 
                                        (((uint16)LoadMode &0x3U) << output_channel)));
}

FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetInterruptEventCount(VAR(uint32,AUTOMATIC) Base,VAR(uint16,AUTOMATIC) EventCount)
{
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetInterruptSource(uint32 Base,
                                                    VAR(Cdd_Pwm_InterruptSourceType,AUTOMATIC) InterruptSource)
{
    ...
    if(!(((int_source > 0U) && (int_source < 9U)) ||
           (int_source == 10U) || (int_source == 12U) ||
           (int_source == 14U)))
    {
    ...
    if((InterruptSource == CDD_PWM_INT_TBCTR_U_CMPC) ||
       (InterruptSource == CDD_PWM_INT_TBCTR_U_CMPD) ||
       (InterruptSource == CDD_PWM_INT_TBCTR_D_CMPC) ||
       (InterruptSource == CDD_PWM_INT_TBCTR_D_CMPD))
    {
    ...
    else if((InterruptSource == CDD_PWM_INT_TBCTR_U_CMPA) ||
            (InterruptSource == CDD_PWM_INT_TBCTR_U_CMPB) ||
            (InterruptSource == CDD_PWM_INT_TBCTR_D_CMPA) ||
            (InterruptSource == CDD_PWM_INT_TBCTR_D_CMPB))
    {
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetCounterCompareShadowLoadMode(uint32 Base,
                                                    ...
                                                    VAR(Cdd_Pwm_CounterCompareLoadModeType,AUTOMATIC) LoadMode)
{
    ...
    HWREGH(offset) = ((HWREGH(offset) & ~((0x3U << syncoffset) | // Clear sync Mode
                        ...
                        ((((uint16)LoadMode >> 2U) << syncoffset) |
                        (((uint16)LoadMode & 0x3U) << loadoffset)));
}

FUNC(void, CDD_PWM_CODE) Cdd_Pwm_PrivSetClockPrescaler(uint32 Base, Cdd_Pwm_ClockDividerType Prescale,
...
FUNC(void, CDD_PWM_CODE) Cdd_Pwm_PrivSetEmulationMode(VAR(uint32, AUTOMATIC) Base, 
                                VAR(Cdd_Pwm_EmulationModeType, AUTOMATIC) EmulationMode)
{
    /* Write to FREE_SOFT bits */
    HWREGH(Base + EPWM_O_TBCTL) =  ((HWREGH(Base + EPWM_O_TBCTL) & (~EPWM_TBCTL_FREE_SOFT_M)) |
                                                                ((uint16)EmulationMode << EPWM_TBCTL_FREE_SOFT_S));
}
...
FUNC(void, CDD_PWM_CODE) Cdd_Pwm_HwUnitInit(void)
{
    ...
    for (Cdd_Pwm_InstanceType hwunit_id = 0U; hwunit_id < CDD_PWM_COUNT; hwunit_id++)
    {
        ...
        countmode = (CDD_PWM_ASYMMETRIC_WAVEFORM == hwunit_cfg->symmetry)
    ...
    for (channel_id = 0U; channel_id < CDD_PWM_CHANNEL_COUNT; channel_id++)
    {
        ...
        counter_compare = (CDD_PWM_OUTPUT_A == channelcfg->outputchannel)?\
                                                (CDD_PWM_COUNTER_COMPARE_A):(CDD_PWM_COUNTER_COMPARE_B);
        ...
        Cdd_Pwm_PrivSetActionQualifierShadowLoadMode(base_addr,channelcfg->outputchannel,CDD_PWM_AQ_LOAD_ON_CNTR_ZERO);
...
FUNC(void, CDD_PWM_CODE) Cdd_Pwm_SetIdleOutput(VAR(Cdd_Pwm_ChannelType, AUTOMATIC) ChannelId)
{
    ...
    Cdd_Pwm_ActionQualifierOutputType output = (channel_cfg->idlestate == CDD_PWM_HIGH)?\
    ...
    if(TRUE == Cdd_Pwm_DrvObjPtr->channelobj[ChannelId].channel_active)
    {
        ...
        Cdd_Pwm_UpdateNotificationAction(ChannelId,Cdd_Pwm_DrvObjPtr->channelobj[ChannelId].channelnotif_enable,FALSE);
    }
#endif
...
FUNC(void, CDD_PWM_CODE)
Cdd_Pwm_UpdateDutyCycle(VAR(Cdd_Pwm_ChannelType, AUTOMATIC) ChannelId,
                        VAR(Cdd_Pwm_DutyCycleType, AUTOMATIC) DutyCycle)
{
    const Cdd_Pwm_ChannelCfgType *channel_cfg = &(Cdd_Pwm_ConfigPtr->channelcfg[ChannelId]);
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetCountModeAfterSync(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetSyncInPulseSource(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                            VAR(Cdd_Pwm_SyncInPulseSourceType,AUTOMATIC) Source)
{
    uint32 base = (Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr);

    HWREGH(base + EPWM_O_SYNCINSEL) =
            (HWREGH(base + EPWM_O_SYNCINSEL) & ~((uint16)EPWM_SYNCINSEL_SEL_M)) |
                    ((uint16)Source & EPWM_SYNCINSEL_SEL_M);
}

FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivConfigureSyncOutPulseSource(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                      VAR(Cdd_Pwm_SyncOutPulseSourceType,AUTOMATIC) Source,VAR(boolean,AUTOMATIC) Mode)
{
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetOneShotSyncOutTrigger(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                Cdd_Pwm_OneShotSyncOutTriggerType Trigger)
{
    /* Set Source for One-Shot Sync-Out Pulse. */
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
    HWREGH(base + EPWM_O_TBCTL3) =
            (HWREGH(base + EPWM_O_TBCTL3) & ~((uint16)EPWM_TBCTL3_OSSFRCEN)) | (uint16)Trigger;
}

FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetPeriodLoadMode(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivConfigurePhaseShiftLoad(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                            VAR(boolean,AUTOMATIC) Mode)
{
    /* Set PHSEN bit */
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSelectPeriodLoadEvent(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivConfigureOneShotSync(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                                                VAR(boolean,AUTOMATIC) Mode)
{
...
FUNC(boolean,CDD_PWM_CODE) Cdd_Pwm_PrivGetTimeBaseCounterOverflowStatus(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId)
{
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetPhaseShift(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetCounterCompareValue(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                VAR(Cdd_Pwm_CounterCompareModuleType,AUTOMATIC) CompModule,VAR(uint16,AUTOMATIC) CompCount)
{
    ...
    if((CompModule == CDD_PWM_COUNTER_COMPARE_A) ||
        (CompModule == CDD_PWM_COUNTER_COMPARE_B))
    {
...
FUNC(uint16,CDD_PWM_CODE) Cdd_Pwm_PrivGetCounterCompareValue(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                    VAR(Cdd_Pwm_CounterCompareModuleType,AUTOMATIC) CompModule)
{
    uint32 base;
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivConfigureEpwmXLink(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(boolean,CDD_PWM_CODE) Cdd_Pwm_PrivGetCounterCompareShadowStatus(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                            VAR(Cdd_Pwm_OutputChannelType,AUTOMATIC) OutputChannel)
{
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivConfigureLinkDutyHR(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                            VAR(boolean,AUTOMATIC) Mode)
{
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetActionQualifierT1TriggerSource(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetActionQualifierT2TriggerSource(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                      VAR(Cdd_Pwm_ActionQualifierTriggerSourceType,AUTOMATIC) Trigger)
{
    /* Set T2 Trigger Source */
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
    HWREGH(base + EPWM_O_AQTSRCSEL) =
        ((HWREGH(base + EPWM_O_AQTSRCSEL) & ~((uint16)EPWM_AQTSRCSEL_T2SEL_M)) |
                                                            (uint16)((uint16)Trigger << EPWM_AQTSRCSEL_T2SEL_S));
}

FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetActionQualifierAction(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                            ...
                            VAR(Cdd_Pwm_ActionQualifierOutputEventType,AUTOMATIC) Event)
{
    ...
    if(((uint16)Event & 0x1U) == 1U)
    {
        ...
        HWREGH(base + register_offset) =
            ((HWREGH(base + register_offset) & ~(3U << ((uint16)Event - 1U))) | \
    ...
    else
    {
        ...
        base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
        HWREGH(base + offset) =
                    ((HWREGH(base + offset) & ~(3U << (uint16)Event)) | \
                    ((uint16)Output << (uint16)Event));
    }
}

FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetActionQualifierActionComplete(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                            VAR(Cdd_Pwm_OutputChannelType,AUTOMATIC) OutputChannel,
                                             ...
                                             VAR(Cdd_Pwm_ActionQualifierContForceType,AUTOMATIC) Mode)
{
    ...
    HWREGH(base + EPWM_O_AQSFRC) =
            ((HWREGH(base + EPWM_O_AQSFRC) & ~((uint16)EPWM_AQSFRC_RLDCSF_M)) |
                                                    (uint16)((uint16)Mode << EPWM_AQSFRC_RLDCSF_S));
}

FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetActionQualifierContSwForceAction(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                        VAR(Cdd_Pwm_OutputChannelType,AUTOMATIC) OutputChannel,
...

{
    ...
    if(CDD_PWM_OUTPUT_A == OutputChannel)
    {
        HWREGH(base + EPWM_O_AQCSFRC) =
                    ((HWREGH(base + EPWM_O_AQCSFRC) & ~EPWM_AQCSFRC_CSFA_M) | ((uint16)Output));
    }
    else
    {
        HWREGH(base + EPWM_O_AQCSFRC) =
                    ((HWREGH(base + EPWM_O_AQCSFRC) & ~EPWM_AQCSFRC_CSFB_M) |
                    ((uint16)Output << EPWM_AQCSFRC_CSFB_S)) ;
    }
}

FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetActionQualifierSwAction(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                        VAR(Cdd_Pwm_OutputChannelType,AUTOMATIC) OutputChannel,
                                                    VAR(Cdd_Pwm_ActionQualifierOutputType,AUTOMATIC) Output)
{
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
    ...
    {
        HWREGH(base + EPWM_O_AQSFRC) =
                        ((HWREGH(base + EPWM_O_AQSFRC) & ~EPWM_AQSFRC_ACTSFA_M) | ((uint16)Output));
    }
    else
    {
        HWREGH(base + EPWM_O_AQSFRC) =
                        ((HWREGH(base + EPWM_O_AQSFRC) & ~EPWM_AQSFRC_ACTSFB_M) |
                                                                ((uint16)Output << EPWM_AQSFRC_ACTSFB_S));
    }
}

FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivForceActionQualifierSwAction(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                        VAR(Cdd_Pwm_OutputChannelType,AUTOMATIC) OutputChannel)
{ 
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetDeadBandOutputSwapMode(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                        VAR(Cdd_Pwm_OutputChannelType,AUTOMATIC) OutputChannel,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetDeadBandDelayMode(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetDeadBandDelayPolarity(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
{ 
    ...
    HWREGH(base + EPWM_O_DBCTL) = \
                    ((HWREGH(base + EPWM_O_DBCTL) & ~ (1U << shift)) | ((uint16)Polarity << shift));
}

FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetRisingEdgeDeadBandDelayInput(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                        VAR(Cdd_Pwm_OutputChannelType,AUTOMATIC) OutputChannel)
{
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetFallingEdgeDeadBandDelayInput(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetDeadBandControlShadowLoadMode(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivDisableDeadBandControlShadowLoadMode(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId)
{
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetFallingEdgeDelayCountShadowLoadMode(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                        VAR(Cdd_Pwm_DeadBandDelayLoadModeType,AUTOMATIC) LoadMode)
{
    ...
    HWREGH(base + EPWM_O_DBCTL) =
            ((HWREGH(base + EPWM_O_DBCTL) & ~EPWM_DBCTL_LOADFEDMODE_M) |
                ...
                ((uint16)LoadMode << EPWM_DBCTL_LOADFEDMODE_S)));
}

FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivDisableFallingEdgeDelayCountShadowLoadMode(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId)
{
    /* Disable the shadow Mode. */
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
    HWREGH(base + EPWM_O_DBCTL) =
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetDeadBandCounterClock(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                             VAR(Cdd_Pwm_DeadBandClockModeType,AUTOMATIC) ClockMode)
{
    /* Set the DB clock Mode */
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
    HWREGH(base + EPWM_O_DBCTL) = ((HWREGH(base + EPWM_O_DBCTL) & ~EPWM_DBCTL_HALFCYCLE) | \
                                                                    ((uint16)ClockMode << 15U));
}

FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetRisingEdgeDelayCount(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetFallingEdgeDelayCount(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivConfigureChopper(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                VAR(boolean,AUTOMATIC) Mode)
{
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetChopperDutyCycle(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetChopperFreq(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
VAR(uint16,AUTOMATIC) FreqDiv)
{
    /* Set the chopper clock */
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
    HWREGH(base + EPWM_O_PCCTL) = ((HWREGH(base + EPWM_O_PCCTL) & ~(uint16)EPWM_PCCTL_CHPFREQ_M) | \
                                                                        (FreqDiv << EPWM_PCCTL_CHPFREQ_S));
}

FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetChopperFirstPulseWidth(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
VAR(uint16,AUTOMATIC) FirstPulseWidth)
{
    ...
    HWREGH(base + EPWM_O_PCCTL) =
            ((HWREGH(base + EPWM_O_PCCTL) &
            ~(uint16)EPWM_PCCTL_OSHTWTH_M) |
            (FirstPulseWidth << EPWM_PCCTL_OSHTWTH_S));
}

FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivConfigureTripZoneSignals(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                            VAR(uint16,AUTOMATIC) TzSignal,VAR(boolean,AUTOMATIC) Select)
{
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivConfigureTripZone2Signals(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                        VAR(uint16,AUTOMATIC) TzSignal,VAR(boolean,AUTOMATIC) Select)
{
    /* Set the trip zone bits */
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
                                 ...
                                 VAR(Cdd_Pwm_TripZoneDigitalCompareOutputEventType,AUTOMATIC) DcEvent)
{
    ...
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
    HWREGH(base + EPWM_O_TZDCSEL) = ((HWREGH(base + EPWM_O_TZDCSEL) & ~(0x7U << (uint16)dc_type)) |\
                                                                    ((uint16)DcEvent << (uint16)dc_type));
}

FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivConfigureTripZoneAdvAction(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                            VAR(boolean,AUTOMATIC) Select)
{
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetTripZoneAction(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
VAR(Cdd_Pwm_TripZoneActionEventType,AUTOMATIC) TzEvent, VAR(Cdd_Pwm_TripZoneActionType,AUTOMATIC) TzAction)
{
    ...
    HWREGH(base + EPWM_O_TZCTL) = ((HWREGH(base + EPWM_O_TZCTL) & ~(0x3U << tzevent)) | \
                                                                ((uint16)TzAction << tzevent));
}

FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetTripZoneAdvAction(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                    ...
                                                    VAR(Cdd_Pwm_TripZoneAdvancedActionType,AUTOMATIC) TzAdvAction)
{
    ...
    HWREGH(base + EPWM_O_TZCTL2) =  ((HWREGH(base + EPWM_O_TZCTL2) & ~(0x7U << tzadv_event)) | \
                                                        ((uint16)TzAdvAction << tzadv_event));

    HWREGH(base + EPWM_O_TZCTL2) |= EPWM_TZCTL2_ETZE;
}

FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetTripZoneAdvDigitalCompareAction(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                        VAR(Cdd_Pwm_OutputChannelType,AUTOMATIC) OutputChannel,
                              ...
                              VAR(Cdd_Pwm_TripZoneAdvancedActionType,AUTOMATIC) TzAdvDcAction)
{
    ...
    HWREGH(base + tripzoneaction) = ((HWREGH(base + tripzoneaction) & ~(0x7U << tzadv_dcevent)) | \
                                                                ((uint16)TzAdvDcAction << tzadv_dcevent));

    HWREGH(base + EPWM_O_TZCTL2) |= EPWM_TZCTL2_ETZE;
}
                              
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivConfigureTripZoneInterrupt(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                            VAR(uint16,AUTOMATIC) TzInterrupt,
                                                            VAR(boolean,AUTOMATIC) Select)
{
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
    if(TRUE == Select)
...
FUNC(uint16,CDD_PWM_CODE) Cdd_Pwm_PrivGetCycleByCycleTripZoneFlagStatus(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId)
{
                                 ...
                                 VAR(Cdd_Pwm_CbcTripZoneClearModeType,AUTOMATIC) ClearEvent)
{
    ...
    HWREGH(base + EPWM_O_TZCLR) =
                ...
                ((uint16)ClearEvent << EPWM_TZCLR_CBCPULSE_S));
}

FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivClearTripZoneFlag(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                        VAR(uint16,AUTOMATIC) TzFlags)
{
    /* Clear Trip zone Event fag */
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivClearCycleByCycleTripZoneFlag(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivClearOneShotTripZoneFlag(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivForceTripZoneEvent(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                    VAR(uint16,AUTOMATIC) TzForceEvent)
{
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivConfigureTripOutSource(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivConfigureInterruptEventCountInit(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                VAR(boolean,AUTOMATIC) Select)
{
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetInterruptEventCountInitValue(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                            VAR(uint16,AUTOMATIC) EventCount)
{
    /* Set the Pre-interrupt Event Count */
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
    HWREGH(base + EPWM_O_ETCNTINIT) = ((HWREGH(base + EPWM_O_ETCNTINIT) & ~EPWM_ETCNTINIT_INTINIT_M) | \
                                                                    (uint16)(EventCount & 0xFU));
}
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetMixEvtTriggerSource(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivConfigureAdcTrigger(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetAdcTriggerSource(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                         ...
                         VAR(Cdd_Pwm_AdcStartOfConversionSourceType,AUTOMATIC) SocSource)
{
    ...
    if((SocSource == CDD_PWM_SOC_TBCTR_U_CMPC) ||
    (SocSource == CDD_PWM_SOC_TBCTR_U_CMPD) ||
    (SocSource == CDD_PWM_SOC_TBCTR_D_CMPC) ||
    (SocSource == CDD_PWM_SOC_TBCTR_D_CMPD))
    {
    ...
    if(AdcSocType == CDD_PWM_SOC_A)
    {
        ...
        if((SocSource == CDD_PWM_SOC_TBCTR_U_CMPA) ||
        (SocSource == CDD_PWM_SOC_TBCTR_U_CMPB) ||
        (SocSource == CDD_PWM_SOC_TBCTR_D_CMPA) ||
        (SocSource == CDD_PWM_SOC_TBCTR_D_CMPB))
        {
            /* Enable events based on comp A or comp B */
            HWREGH(base + EPWM_O_ETSEL) &= ~EPWM_ETSEL_SOCASELCMP;
        }
        else if((SocSource == CDD_PWM_SOC_TBCTR_U_CMPC) ||
                (SocSource == CDD_PWM_SOC_TBCTR_U_CMPD) ||
                (SocSource == CDD_PWM_SOC_TBCTR_D_CMPC) ||
                (SocSource == CDD_PWM_SOC_TBCTR_D_CMPD))
        {
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetAdcTriggerEventPrescale(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                VAR(Cdd_Pwm_AdcStartOfConversionType,AUTOMATIC) AdcSocType,
                                uint16 PreScaleCount)
{
    ...
    if(AdcSocType == CDD_PWM_SOC_A)
    {
        ...
        HWREGH(base + EPWM_O_ETSOCPS) = \
                                ((HWREGH(base + EPWM_O_ETSOCPS) & ~EPWM_ETSOCPS_SOCAPRD2_M) | PreScaleCount);
    }
    else
    {
        /* Set the Count for SOC B */
        HWREGH(base + EPWM_O_ETSOCPS) = ((HWREGH(base + EPWM_O_ETSOCPS) & ~EPWM_ETSOCPS_SOCBPRD2_M) | \
                                                                (PreScaleCount << EPWM_ETSOCPS_SOCBPRD2_S));
    }
}

FUNC(boolean,CDD_PWM_CODE) Cdd_Pwm_PrivGetAdcTriggerFlagStatus(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                             VAR(Cdd_Pwm_AdcStartOfConversionType,AUTOMATIC) AdcSocType)
{
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivClearAdcTriggerFlag(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                         VAR(Cdd_Pwm_AdcStartOfConversionType,AUTOMATIC) AdcSocType)
{
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivConfigureAdcTriggerEventCountInit (VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
        VAR(Cdd_Pwm_AdcStartOfConversionType,AUTOMATIC) AdcSocType,VAR(boolean,AUTOMATIC) Select)
{
    ...
    else
    {
        HWREGH(base + EPWM_O_ETCNTINITCTL) &=
                                ~(1U << ((uint16)AdcSocType + 14U));
    }
    
}

FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivForceAdcTriggerEventCountInit(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                   VAR(Cdd_Pwm_AdcStartOfConversionType,AUTOMATIC) AdcSocType)
{
    /* Load the Interrupt Event Counter value */
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetAdcTriggerEventCountInitValue(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                      VAR(Cdd_Pwm_AdcStartOfConversionType,AUTOMATIC) AdcSocType,
                                      uint16 EventCount)
{
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
...
FUNC(uint16,CDD_PWM_CODE) Cdd_Pwm_PrivGetAdcTriggerEventCount(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                             VAR(Cdd_Pwm_AdcStartOfConversionType,AUTOMATIC) AdcSocType)
{
    uint16 eventCount;
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivForceAdcTrigger(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
VAR(Cdd_Pwm_AdcStartOfConversionType,AUTOMATIC) AdcSocType)
{
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSelectDigitalCompareTripInput(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetDigitalCompareBlankingEvent(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetDigitalCompareFilterInput(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivConfigureDigitalCompareEdgeFilter(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                        VAR(boolean,AUTOMATIC) Select)
{
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetDigitalCompareEdgeFilterMode(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                     VAR(Cdd_Pwm_DigitalCompareEdgeFilterModeType,AUTOMATIC) EdgeMode)
{
    ...
    HWREGH(base + EPWM_O_DCFCTL) =
        ...
        ((uint16)EdgeMode << EPWM_DCFCTL_EDGEMODE_S);
}
...
FUNC(uint16,CDD_PWM_CODE) Cdd_Pwm_PrivGetDigitalCompareEdgeFilterEdgeCount(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId)
{
...
FUNC(uint16,CDD_PWM_CODE) Cdd_Pwm_PrivGetDigitalCompareEdgeFilterEdgeStatus(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId)
{
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetDigitalCompareWindowOffset(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetDigitalCompareWindowLength(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetDigitalCompareEventSource(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                  VAR(Cdd_Pwm_OutputChannelType,AUTOMATIC) OutputChannel,
                                  ...
                                  VAR(Cdd_Pwm_DigitalCompareEventSourceType,AUTOMATIC) DcEventSource)
{
    ...
    {
        HWREGH(base + offset) =
                ((HWREGH(base + offset) & ~EPWM_DCACTL_EVT1SRCSEL) |
                (uint16)DcEventSource);
    }
    else
    {
        HWREGH(base + offset) =
                ((HWREGH(base + offset) & ~EPWM_DCACTL_EVT2SRCSEL) |
                ((uint16)DcEventSource << 8U));
    }
}

FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetDigitalCompareEventSyncMode(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                    VAR(Cdd_Pwm_OutputChannelType,AUTOMATIC) OutputChannel,
                                    VAR(Cdd_Pwm_DigitalCompareEventType,AUTOMATIC) DcEvent,
                                    VAR(Cdd_Pwm_DigitalCompareSyncModeType,AUTOMATIC) SyncMode)
{
    ...
    {
        HWREGH(base + offset) =
        ((HWREGH(base + offset) & ~EPWM_DCACTL_EVT1FRCSYNCSEL) | ((uint16)SyncMode << 1U));
    }
    else
    {
        HWREGH(base + offset) =
            ((HWREGH(base + offset) & ~EPWM_DCACTL_EVT2FRCSYNCSEL) | ((uint16)SyncMode << 9U));
    }
}

FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivConfigureDigitalCompareAdcTrigger(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                            VAR(Cdd_Pwm_OutputChannelType,AUTOMATIC) OutputChannel,VAR(boolean,AUTOMATIC) Select)
{
    ...
    {
        HWREGH(base + offset) =
                    (HWREGH(base + offset) | EPWM_DCACTL_EVT1SOCE);
    }
    else
    {
        HWREGH(base + offset) =
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivConfigureDigitalCompareSyncEvent(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                            VAR(Cdd_Pwm_OutputChannelType,AUTOMATIC) OutputChannel,VAR(boolean,AUTOMATIC) Select)
{
    uint32 offset = EPWM_O_DCACTL + ((uint32)OutputChannel * 2U);
    ...
    {
        HWREGH(base + offset) =
                    (HWREGH(base + offset) | EPWM_DCACTL_EVT1SYNCE);
    }
    else
    {
        HWREGH(base + offset) =
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetDigitalCompareCBCLatchMode(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                   VAR(Cdd_Pwm_OutputChannelType,AUTOMATIC) OutputChannel,
                                   VAR(Cdd_Pwm_DigitalCompareEventType,AUTOMATIC) DcEvent,
                                   VAR(Cdd_Pwm_DigitalCompareCbcLatchModeType,AUTOMATIC) LatchMode)
{
    ...
    {
        HWREGH(base + offset) =
                            ((HWREGH(base + offset) & ~EPWM_DCACTL_EVT1LATSEL) | ((uint16)LatchMode << 4U));
    }
    else
    {
        HWREGH(base + offset) =
                        ((HWREGH(base + offset) & ~EPWM_DCACTL_EVT2LATSEL) | ((uint16)LatchMode << 12U));
    }
}
                              ...
                              VAR(Cdd_Pwm_DigitalCompareCBCLatchClearEventType,AUTOMATIC) ClearEvent)
{
    ...
    {
        HWREGH(base + offset) =
        ((HWREGH(base + offset) & ~EPWM_DCACTL_EVT1LATCLRSEL_M) |
            ((uint16)ClearEvent << EPWM_DCACTL_EVT1LATCLRSEL_S));
    }
    else
    {
        HWREGH(base + offset) =
            ((HWREGH(base + offset) & ~EPWM_DCACTL_EVT2LATCLRSEL_M) |
            ((uint16)ClearEvent << EPWM_DCACTL_EVT2LATCLRSEL_S));
    }
}

FUNC(boolean,CDD_PWM_CODE) Cdd_Pwm_PrivGetDigitalCompareCBCLatchStatus(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                     VAR(Cdd_Pwm_OutputChannelType,AUTOMATIC) OutputChannel,
                                     VAR(Cdd_Pwm_DigitalCompareEventType,AUTOMATIC) DcEvent)
{
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivConfigureDigitalCompareCounterCapture(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
            VAR(boolean,AUTOMATIC) Select)
{
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetDigitalCompareCounterShadowMode(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                        ...
                                                        VAR(boolean,AUTOMATIC) Select)
{
    ...
    {
        HWREGH(base + offset) =
                        (HWREGH(base + offset) & ~((uint16)TripInput));
    }    
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivConfigureCaptureInEvent(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                                                VAR(boolean,AUTOMATIC) Select)
{
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivConfigCaptureGateInputPolarity(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivInvertCaptureInputPolarity(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivConfigureIndependentPulseLogic(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                    VAR(boolean,AUTOMATIC) Select)
{
    /* Configures Polarity for Capture Input */
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSelectCaptureTripInput(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                            VAR(uint16,AUTOMATIC) TripInput,
                            VAR(Cdd_Pwm_CaptureInputType,AUTOMATIC) DcType)
{
    ...
    ((HWREGH(base + EPWM_O_CAPTRIPSEL) & ~(0xFU << ((uint16)DcType << 2U))) |
    ((uint16)TripInput << ((uint16)DcType << 2U)));
}
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivConfigureValleyCapture(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                    VAR(boolean,AUTOMATIC) Select)
{
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetValleyTriggerSource(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetValleyTriggerEdgeCounts(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivConfigureValleyHwDelay(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                        VAR(boolean,AUTOMATIC) Select)
{
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetValleySwDelayValue(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetValleyDelayDivider(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(boolean,CDD_PWM_CODE) Cdd_Pwm_PrivGetValleyEdgeStatus(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivConfigureGlobalLoad(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
	                                        VAR(boolean,AUTOMATIC) Select)
{
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetGlobalLoadTrigger(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
VAR(Cdd_Pwm_GlobalLoadTriggerType,AUTOMATIC) LoadTrigger)
{
    /* Set the Global shadow to active load pulse */
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
    HWREGH(base + EPWM_O_GLDCTL) =  ((HWREGH(base + EPWM_O_GLDCTL) & ~EPWM_GLDCTL_GLDMODE_M) |\
                ((uint16)LoadTrigger << EPWM_GLDCTL_GLDMODE_S));
}

FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetGlobalLoadEventPrescale(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
VAR(uint16,AUTOMATIC) PrescalePulseCount)
{
    /* Set the number of Counts that have to occur before a load strobe is issued */
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
    HWREGH(base + EPWM_O_GLDCTL) = ((HWREGH(base + EPWM_O_GLDCTL) & ~EPWM_GLDCTL_GLDPRD_M) |\
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivConfigureGlobalLoadOneShotMode(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
			VAR(boolean,AUTOMATIC) Select)
{
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivConfigureGlobalLoadRegisters(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivLockRegisters(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivConfigureXCmpMode(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
			                                        VAR(boolean,AUTOMATIC) Select)
{
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivConfigureSplitXCmp(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
			VAR(boolean,AUTOMATIC) Select)
{
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
    uint32 offset = base + EPWM_O_XCMP;
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivAllocAXCmp(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivAllocBXCmp(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                VAR(Cdd_Pwm_XCmp_AllocCmpBType,AUTOMATIC) Alloctype)
{
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
    uint32 offset = base + EPWM_O_XCMP + EPWM_O_XCMPCTL1;

    HWREGH(offset) = (HWREGH(offset) & ~EPWM_XCMPCTL1_XCMPB_ALLOC_M) | \
                                                    ((uint32)Alloctype << EPWM_XCMPCTL1_XCMPB_ALLOC_S);
}

FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetXCmpRegValue(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetXCmpShadowRegValue(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetXMinMaxRegValue(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetXCmpActionQualifierAction(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                        ...
                                                        VAR(Cdd_Pwm_XCmpAqOutputEventType,AUTOMATIC) Event)
{
    ...
    if(ShadowSet == CDD_PWM_XCMP_ACTIVE)
    {
        ...
        HWREGH(base + offset) = \
                    (HWREGH(base + offset) & ~(3UL << event)) | ((uint32)Output << event);
    }
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetXCmpLoadMode(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetXCmpShadowLevel(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
VAR(Cdd_Pwm_XCmpShadowLevelType,AUTOMATIC) Level)
{
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
    uint32 offset = base + EPWM_O_XCMP + EPWM_O_XLOADCTL;
    HWREG(offset) =  (HWREG(offset) & ~EPWM_XLOADCTL_SHDWLEVEL_M) | \
                                                            ((uint32)Level << EPWM_XLOADCTL_SHDWLEVEL_S);
}

FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetXCmpShadowBufPtrLoadOnce(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                 VAR(Cdd_Pwm_XCmpShadowBufPtrType,AUTOMATIC) Ptr)
{
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
    uint32 offset = base + EPWM_O_XCMP + EPWM_O_XLOADCTL;
    HWREG(offset) = (HWREG(offset) & ~EPWM_XLOADCTL_SHDWBUFPTR_LOADONCE_M) | \
                                                    ((uint32)Ptr << EPWM_XLOADCTL_SHDWBUFPTR_LOADONCE_S);
}

FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetXCmpShadowRepeatBufxCount(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                        VAR(Cdd_Pwm_XCmpShadowSetType,AUTOMATIC) BufferSet,VAR(uint32,AUTOMATIC) Count)
{
    ...
    {
        HWREG(offset) =
                (HWREG(offset) & ~EPWM_XLOADCTL_RPTBUF2PRD_M) |
                ((uint32)Count << EPWM_XLOADCTL_RPTBUF2PRD_S);
    }
    else if(BufferSet == CDD_PWM_XCMP_SHADOW3)
    {
        HWREG(offset) =
                (HWREG(offset) & ~EPWM_XLOADCTL_RPTBUF3PRD_M) |
                ((uint32)Count << EPWM_XLOADCTL_RPTBUF3PRD_S);
    }
    else
    {
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivConfigureMinimumDeadBand(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                        VAR(Cdd_Pwm_OutputChannelType,AUTOMATIC) OutputChannel,
                                                                                VAR(boolean,AUTOMATIC) Select)
{
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivInvertMinimumDeadBandSignal(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                        VAR(Cdd_Pwm_OutputChannelType,AUTOMATIC) OutputChannel,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSelectMinimumDeadBandAndOrLogic(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                        VAR(Cdd_Pwm_OutputChannelType,AUTOMATIC) OutputChannel,
                                                ...
                                                VAR(Cdd_Pwm_MindbReferenceSignalType,AUTOMATIC) ReferenceSignal)
{
    ...
    if(CDD_PWM_OUTPUT_A == OutputChannel)
    {
        ...
        HWREGH(offset) =
                (HWREGH(offset) & ~EPWM_MINDBCFG_SELA_M) |
                ((uint32)ReferenceSignal << EPWM_MINDBCFG_SELA_S);
    }
    else
    {
        /* Select reference Source for minimum dead band on EPWMB */
        HWREG(offset) =
                (HWREG(offset) & ~EPWM_MINDBCFG_SELB_M) |
                ((uint32)ReferenceSignal << EPWM_MINDBCFG_SELB_S);
    }
}

FUNC(uint16,CDD_PWM_CODE) Cdd_Pwm_PrivGetMinDeadBandDelay(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                        VAR(Cdd_Pwm_OutputChannelType,AUTOMATIC) OutputChannel)
{
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetMinDeadBandDelay(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                        VAR(Cdd_Pwm_OutputChannelType,AUTOMATIC) OutputChannel,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivConfigureIllegalComboLogic(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                            VAR(Cdd_Pwm_OutputChannelType,AUTOMATIC) OutputChannel,
                                                                                VAR(boolean,AUTOMATIC) Select)
{
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSelectXbarInput(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                        VAR(Cdd_Pwm_OutputChannelType,AUTOMATIC) OutputChannel,
                                                                    VAR(Cdd_Pwm_XbarInputType,AUTOMATIC) XbarInput)
{
    ...
    if(CDD_PWM_OUTPUT_A == OutputChannel)
    {
        ...
        HWREGH(offset + EPWM_O_LUTCTLA) =
            (HWREGH(offset + EPWM_O_LUTCTLA) & ~EPWM_LUTCTLA_SELXBAR_M) |
            ((uint32)XbarInput << EPWM_LUTCTLA_SELXBAR_S);
    }        
    else
    {
        /* Select one of the 16 outputs of ICL XBAR for EPWMB */
        HWREGH(offset + EPWM_O_LUTCTLB) =
            (HWREGH(offset + EPWM_O_LUTCTLB) & ~EPWM_LUTCTLB_SELXBAR_M) | 
                                                ((uint16)XbarInput << EPWM_LUTCTLB_SELXBAR_S);
    }
}

FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetLutDecX(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                VAR(Cdd_Pwm_OutputChannelType,AUTOMATIC) OutputChannel,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivConfigureDiodeEmulationMode(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
			VAR(boolean,AUTOMATIC) Select)
{
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetDiodeEmulationMode(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetDiodeEmulationReentryDelay(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                                    VAR(uint16,AUTOMATIC) Delay)
{
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
    uint32 offset = base + EPWM_O_DE;
    HWREGH(offset + EPWM_O_DECTL) = (HWREGH(offset + EPWM_O_DECTL) & ~EPWM_DECTL_REENTRYDLY_M) | \
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSelectDiodeEmulationPwmSignal(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                        VAR(Cdd_Pwm_OutputChannelType,AUTOMATIC) OutputChannel,
                                                VAR(Cdd_Pwm_DiodeEmulationSignalType,AUTOMATIC) DiodeEmuationsignal)
{
    ...
    {
        HWREGH(offset) =
                (HWREGH(offset) & ~EPWM_DEACTCTL_PWMA_M) |
                ((uint16)DiodeEmuationsignal << EPWM_DEACTCTL_PWMA_S);
    }
    else
    {
        HWREGH(offset) =
                (HWREGH(offset) & ~EPWM_DEACTCTL_PWMB_M) |
                ((uint16)DiodeEmuationsignal << EPWM_DEACTCTL_PWMB_S);
    }
}

FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSelectDiodeEmulationTripSignal(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                        VAR(Cdd_Pwm_OutputChannelType,AUTOMATIC) OutputChannel,
...
FUNC(void,CDD_PWM_CODE) Cdd_Pwm_PrivSetDiodeEmulationMonitorModeStep(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId, \
                    VAR(Cdd_Pwm_DiodeEmulationDirectionType,AUTOMATIC) Direction, VAR(uint8,AUTOMATIC) StepSize)
{
    ...
    {
        HWREGH(offset) =
                (HWREGH(offset) & ~EPWM_DEMONSTEP_INCSTEP_M) |
                (StepSize << EPWM_DEMONSTEP_INCSTEP_S);
    }
    else
    {
        HWREG(offset) =
                (HWREG(offset) & ~EPWM_DEMONSTEP_DECSTEP_M) |
                                     ...
                                     VAR(boolean, AUTOMATIC) NotificationMode, VAR(boolean, AUTOMATIC) Mode)
{
    ...
    {
        if((CDD_PWM_ASYMMETRIC_WAVEFORM == Cdd_Pwm_ConfigPtr->hwunitcfg[hw_index].symmetry) && \
                   (FALSE == Mode)  &&  (3U ==  Cdd_Pwm_DrvObjPtr->hwunitobj[hw_index].zero_active))
        {
                               ...
                               VAR(boolean, AUTOMATIC) Mode)
{
    ...
    else if((event_source & ((uint16)CDD_PWM_ETMIX_TBCTR_ZERO)) == ((uint16)CDD_PWM_ETMIX_TBCTR_ZERO))
    {
        ...
        * If atleast one channel of the instance has notification enabled then the notification for the instance is also 
...
FUNC(void, CDD_PWM_CODE) Cdd_Pwm_PrivHrpwmSetPhaseShift(VAR(Cdd_Pwm_InstanceType, AUTOMATIC) InstanceId,
...
FUNC(void, CDD_PWM_CODE) Cdd_Pwm_PrivHrpwmSetHiResPhaseShiftOnly(VAR(Cdd_Pwm_InstanceType, AUTOMATIC) InstanceId,
...
FUNC(void, CDD_PWM_CODE) Cdd_Pwm_PrivHrpwmSetTimeBasePeriod(VAR(Cdd_Pwm_InstanceType, AUTOMATIC) InstanceId,
...
FUNC(void, CDD_PWM_CODE) Cdd_Pwm_PrivHrpwmSetHiResTimeBasePeriodOnly(VAR(Cdd_Pwm_InstanceType, AUTOMATIC) InstanceId,
...
FUNC(void, CDD_PWM_CODE) Cdd_Pwm_PrivHrpwmSetMepEdgeSelect(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                        VAR(Cdd_Pwm_OutputChannelType,AUTOMATIC) OutputChannel,
                                                        VAR(Cdd_Pwm_HrpwmMepEdgeModeType, AUTOMATIC) MepEdgeMode)
{
    ...
    HWREGH(base + EPWM_O_HRCNFG) =
             ((HWREGH(base + EPWM_O_HRCNFG) & ~(0x3U << (uint16)channel )) |
              ((uint16)MepEdgeMode << (uint16)channel));

}

FUNC(void, CDD_PWM_CODE) Cdd_Pwm_PrivHrpwmSetMepControlMode(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                        VAR(Cdd_Pwm_OutputChannelType,AUTOMATIC) OutputChannel,
                                                        VAR(Cdd_Pwm_HrpwmMepCtrlModeType, AUTOMATIC) MepCtrlMode)
{
    ...
    /* Set the MEP control */
    HWREGH(base + EPWM_O_HRCNFG) =
       ((HWREGH(base + EPWM_O_HRCNFG) & ~(0x1U << ((uint16)channel + 2U))) |
                                                    ...
                                                    VAR(Cdd_Pwm_HrpwmLoadModeType, AUTOMATIC) LoadEvent)
{
    ...
    HWREGH(base + EPWM_O_HRCNFG) =
       ((HWREGH(base + EPWM_O_HRCNFG) & ~(0x3U << ((uint16)channel + 3U))) |
         ((uint16)LoadEvent << ((uint16)channel + 3U)));

}

FUNC(void, CDD_PWM_CODE) Cdd_Pwm_PrivHrpwmSetOutputSwapMode(VAR(Cdd_Pwm_InstanceType, AUTOMATIC) InstanceId, 
...
FUNC(void, CDD_PWM_CODE) Cdd_Pwm_PrivHrpwmSetChannelBOutputPath(VAR(Cdd_Pwm_InstanceType, AUTOMATIC) InstanceId, 
...
FUNC(void, CDD_PWM_CODE) Cdd_Pwm_PrivHrpwmConfigureAutoConversion(VAR(Cdd_Pwm_InstanceType, AUTOMATIC) InstanceId,
                                                                                VAR(boolean,AUTOMATIC) Select)
{
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
    if(TRUE == Select)
...
FUNC(void, CDD_PWM_CODE) Cdd_Pwm_PrivHrpwmConfigurePeriodControl(VAR(Cdd_Pwm_InstanceType, AUTOMATIC) InstanceId,
                                                                                VAR(boolean,AUTOMATIC) Select)
{
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
    if(TRUE == Select)
...
FUNC(void, CDD_PWM_CODE) Cdd_Pwm_PrivHrpwmConfigurePhaseShiftLoad(VAR(Cdd_Pwm_InstanceType, AUTOMATIC) InstanceId,
                                                                                VAR(boolean,AUTOMATIC) Select)
{
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
    if(TRUE == Select)
...
FUNC(void, CDD_PWM_CODE) Cdd_Pwm_PrivHrpwmSetSyncPulseSource(VAR(Cdd_Pwm_InstanceType, AUTOMATIC) InstanceId,
...
FUNC(void, CDD_PWM_CODE) Cdd_Pwm_PrivHrpwmSetTranslatorRemainder(VAR(Cdd_Pwm_InstanceType, AUTOMATIC) InstanceId,
...
FUNC(void, CDD_PWM_CODE) Cdd_Pwm_PrivHrpwmSetCounterCompareValue(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                        VAR(Cdd_Pwm_OutputChannelType,AUTOMATIC) OutputChannel,
...
FUNC(uint32, CDD_PWM_CODE) Cdd_Pwm_PrivHrpwmGetCounterCompareValue(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                        VAR(Cdd_Pwm_OutputChannelType,AUTOMATIC) OutputChannel)
{
...
FUNC(uint16, CDD_PWM_CODE) Cdd_Pwm_PrivGetHiResCounterCompareValueOnly(VAR(Cdd_Pwm_InstanceType,AUTOMATIC) InstanceId,
                                                        VAR(Cdd_Pwm_OutputChannelType,AUTOMATIC) OutputChannel)
{
...
FUNC(void, CDD_PWM_CODE) Cdd_Pwm_PrivHrpwmSetRisingEdgeDelay(VAR(Cdd_Pwm_InstanceType, AUTOMATIC) InstanceId,
...
FUNC(void, CDD_PWM_CODE) Cdd_Pwm_PrivHrpwmSetHiResRisingEdgeDelayOnly(VAR(Cdd_Pwm_InstanceType, AUTOMATIC) InstanceId,
...
FUNC(void, CDD_PWM_CODE) Cdd_Pwm_PrivHrpwmSetFallingEdgeDelay(VAR(Cdd_Pwm_InstanceType, AUTOMATIC) InstanceId,
...
FUNC(void, CDD_PWM_CODE) Cdd_Pwm_PrivHrpwmSetHiResFallingEdgeDelayOnly(VAR(Cdd_Pwm_InstanceType, AUTOMATIC) InstanceId,
...
FUNC(void, CDD_PWM_CODE) Cdd_Pwm_PrivHrpwmSetMepStep(VAR(Cdd_Pwm_HrpwmCalInstanceType, AUTOMATIC) InstanceId,
                                                                                VAR(uint16, AUTOMATIC) MepCount)
{
    ...
    HWREGH(base + HRPWMCAL_O_HRMSTEP) =
             ((HWREGH(base + HRPWMCAL_O_HRMSTEP) & ~HRPWMCAL_HRMSTEP_HRMSTEP_M) | MepCount);
}

FUNC(void, CDD_PWM_CODE) Cdd_Pwm_PrivHrpwmSetDeadbandMEPEdgeSelect(VAR(Cdd_Pwm_InstanceType, AUTOMATIC) InstanceId,
...
FUNC(void, CDD_PWM_CODE) Cdd_Pwm_PrivHrpwmSetRisingEdgeDelayLoadMode(VAR(Cdd_Pwm_InstanceType, AUTOMATIC) InstanceId,
                                 VAR(Cdd_Pwm_HrpwmLoadModeType, AUTOMATIC) LoadEvent)
{
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
...
FUNC(void, CDD_PWM_CODE) Cdd_Pwm_PrivHrpwmSetFallingEdgeDelayLoadMode(VAR(Cdd_Pwm_InstanceType, AUTOMATIC) InstanceId,
                                                            VAR(Cdd_Pwm_HrpwmLoadModeType, AUTOMATIC) LoadEvent)
{
    uint32 base = Cdd_Pwm_ConfigPtr->hwunitcfg[InstanceId].base_addr;
...
FUNC(void, CDD_PWM_CODE) Cdd_Pwm_PrivHrpwmLockRegisters(VAR(Cdd_Pwm_InstanceType, AUTOMATIC) InstanceId,
...
FUNC(void, CDD_PWM_CODE) Cdd_Pwm_PrivHrpwmSetXCmpRegValue(VAR(Cdd_Pwm_InstanceType, AUTOMATIC) InstanceId,
...
FUNC(void, CDD_PWM_CODE) Cdd_Pwm_PrivHrpwmSetHiResXCmpRegValueOnly(VAR(Cdd_Pwm_InstanceType, AUTOMATIC) InstanceId,
