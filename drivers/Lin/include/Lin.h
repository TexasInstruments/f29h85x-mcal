...
/** \brief Lin_SendFrame - Sends a LIN header and a LIN response, if necessary. The direction of the frame response 
...
/** \brief Lin_GoToSleep - The service instructs the driver to transmit a go-to-sleep-command on the addressed 
 *         LIN channel.
 * 
 * \param[in] Channel LIN channel to be addressed.
 * \param[out] None
...
/** \brief Lin_GoToSleepInternal - Sets the channel state to LIN_CH_SLEEP, enables the wake-up detection and optionally 
 *         sets the LIN hardware unit to reduced power operation mode.
 * 
 * \param[in] Channel LIN channel to be addressed.
 * \param[out] None
 * \pre None
...
/** \brief Lin_WakeupInternal - Generates a wake up pulse and sets the channel state to LIN_CH_OPERATIONAL without 
