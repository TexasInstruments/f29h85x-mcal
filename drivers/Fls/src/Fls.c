...
/* AUTOSAR version information check has to match definition in header file */
#if ((FLS_SW_MAJOR_VERSION != (1U)) || (FLS_SW_MINOR_VERSION != (0U)) || (FLS_SW_PATCH_VERSION != (0U)))
...
#if ((FLS_CFG_MAJOR_VERSION != (1U)) || (FLS_CFG_MINOR_VERSION != (0U)) || (FLS_CFG_PATCH_VERSION != (0U)))
