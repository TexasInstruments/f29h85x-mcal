 ...
 * This API is used to Set CPU timer clock, XCLKOUT, Ethercat clock, Peripheral clocks, MCAN module clocks 
 *
 ...
 * 
 * \param[in] McuMode - ID to select one MCU mode setting from the list provided in configuration set
 * \pre None
 * \post None
 * \return None
 * \retval None
