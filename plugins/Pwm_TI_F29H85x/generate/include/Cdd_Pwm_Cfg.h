...
[!LOOP "CddPwmConfigSet"!]
#define CDD_PWM_CONFIG_PC       Cdd_Pwm_Config
[!ENDLOOP!][!//
[!ENDIF!][!//

/* Macro to define which mode of the driver is enabled */
#define CDD_PWM_ADVANCED_MODE_API    [!IF "(CddPwmConfigSet/CddPwmAdvancedMode)"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]
...
[!VAR "CddPwmHwUnitCount" = "num:i(count(CddPwmConfigSet/CddPwmHwUnitConfig/*))"!][!//
[!IF "((CddPwmConfigSet/CddPwmAdvancedMode) = 'true')"!][!//
[!LOOP "CddPwmConfigSet/CddPwmXlinkConfig/*"!]
/* Xlink group [!"@index"!] symbolic name */
