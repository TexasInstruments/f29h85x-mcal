...
#define CDD_ADC_CFG_MAJOR_VERSION           ([!"substring-before($moduleSoftwareVer,'.')"!]U)
#define CDD_ADC_CFG_MINOR_VERSION           ([!"substring-before(substring-after($moduleSoftwareVer,'.'),'.')"!]U)
...
#define CDD_ADC_DEINIT_API                  [!IF "CddAdcGeneral/CddAdcDeInitApi = 'true'"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]

/* Software group conversion Api macro */
#define CDD_ADC_ENABLE_START_STOP_GROUP_API [!IF "CddAdcGeneral/CddAdcEnableStartStopGroupApi = 'true'"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]

/* Hardware trigger Api macro */
#define CDD_ADC_GLBSW_TRIG_API             [!IF "CddAdcGeneral/CddAdcEnableGlobalSoftwareTrigger = 'true'"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]

#if(CDD_ADC_GLBSW_TRIG_API == STD_ON)
/* Macro to define the number of global software triggers configured */
#define CDD_ADC_GLBSW_TRIG_CNT              ((uint8)[!"num:i(count(CddAdcConfigSet/CddAdcGlobalSwTrigger/*))"!]U)
#endif
...
/* Hardware trigger Api macro */
#define CDD_ADC_HW_TRIGGER_API              [!IF "CddAdcGeneral/CddAdcHwTriggerApi = 'true'"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]
...
#define CDD_ADC_OPEN_SHORT_DETECTION        [!IF "$count>0"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]

#if(STD_ON == CDD_ADC_ENABLE_PPB_API)
/* Macro to define the number of safety checker units configured */
#define CDD_ADC_PPB_CNT                     ((Cdd_Adc_PpbType)[!"num:i(count(CddAdcConfigSet/CddAdcHwUnit/*/CddAdcPpbConfig/*))"!]U)
#endif

/* Read group Api macro */
#define CDD_ADC_READ_GROUP_API              [!IF "CddAdcGeneral/CddAdcReadGroupApi = 'true'"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]

/* Safety checker enabling Api macro */
#define CDD_ADC_SAFETY_CHECK_API            [!IF "CddAdcGeneral/CddAdcSafetyCheckerEnable = 'true'"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]
...
[!IF "num:i(count(CddAdcConfigSet/CddAdcHwUnit/*/CddAdcTriggerRepeater/*)) > 0"!]
...
#define CDD_ADC_VERSION_INFO_API    [!IF "CddAdcGeneral/CddAdcVersionInfoApi = 'true'"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]
...
[!IF "as:modconf('Cdd_Adc/Cdd')[as:path(node:dtos(.))='/TI_F29H85x/Cdd_Adc/Cdd']/CddAdcGeneral/CddAdcEnableGlobalSoftwareTrigger = 'true'"!][!//
...
#define CDD_ADC_EXTCHSEL_CAPABILITY      [!IF "$ExtChnsel = 'true'"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]
