...
[!VAR "CallbackHeaderFileList" = "concat($CallbackHeaderFileList,' ',node:current())"!][!//
[!ENDIF!][!//
[!ENDIF!][!//
[!ENDLOOP!][!//
 ...
 */
#define SPI_INIT_CONFIG_PC       Spi_ConfigObj
[!ENDLOOP!][!//
[!ENDIF!][!//
...
[!ENDLOOP!][!//
[!ENDLOOP!][!//
#define SPI_MAX_CHANNELS_PER_JOB    ((uint8)[!"num:i($SpiMaxChannelsInJob)"!]U)
...
[!ENDLOOP!][!//
[!ENDLOOP!][!//
#define SPI_MAX_JOBS_PER_SEQ       ((uint8)[!"num:i($SpiMaxJobsInSeq)"!]U)
...
#define SPI_CS_VIA_GPIO       [!IF "num:i($is_gpio_chip_select) = '1'"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
